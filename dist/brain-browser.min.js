...
"use strict";var t=function(){function t(t,e){for(var s=0;s<e.length;s++){var r=e[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,s,r){return s&&t(e.prototype,s),r&&t(e,r),e}}();function e(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function s(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function r(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var i=require("../function-node-base"),n=require("../../core/utils"),a="Math.",u="this.",h="this.constants.",o=/decode32\(\s+encode32\(/g,p=/encode32\(\s+decode32\(/g,c=function(){};function l(t,e,s){return-1!==s.paramNames.indexOf(t)}function f(t,e,s,r){var i=s.loc.start;if(!l(t)&&"float"!==e)throw new Error("Error unexpected identifier "+t+" on line "+i.line);if(r.paramTypes[r.paramNames.indexOf(t)]!==e)throw new Error("Error unexpected identifier "+t+" on line "+i.line)}function m(t){return t.replace(o,"((").replace(p,"((")}module.exports=function(o){function p(){return e(this,p),s(this,(p.__proto__||Object.getPrototypeOf(p)).apply(this,arguments))}return r(p,i),t(p,[{key:"generate",value:function(){return this.debug&&c(this),this.prototypeOnly?p.astFunctionPrototype(this.getJsAST(),[],this).join("").trim():(this.functionStringArray=this.astGeneric(this.getJsAST(),[],this),this.functionString=m(this.functionStringArray.join("").trim()),this.functionString)}},{key:"astFunctionDeclaration",value:function(t,e){return this.addFunction&&this.addFunction(null,n.getAstString(this.jsFunctionString,t)),e}},{key:"astFunctionExpression",value:function(t,e){if(this.isRootKernel?(e.push("void"),this.kernalAst=t):e.push(this.returnType),e.push(" "),e.push(this.functionName),e.push("("),!this.isRootKernel)for(var s=0;s<this.paramNames.length;++s){var r=this.paramNames[s];switch(s>0&&e.push(", "),this.getParamType(r)){case"Texture":case"Input":case"Array":e.push("sampler2D");break;default:e.push("float")}e.push(" "),e.push("user_"),e.push(r)}e.push(") {\n");for(var i=0;i<t.body.body.length;++i)this.astGeneric(t.body.body[i],e),e.push("\n");return e.push("}\n"),e}},{key:"astReturnStatement",value:function(t,e){return this.isRootKernel?(e.push("kernelResult = "),this.astGeneric(t.argument,e),e.push(";"),e.push("return;")):this.isSubKernel?(e.push(this.functionName+"Result = "),this.astGeneric(t.argument,e),e.push(";"),e.push("return "+this.functionName+"Result;")):(e.push("return "),this.astGeneric(t.argument,e),e.push(";")),e}},{key:"astLiteral",value:function(t,e){if(isNaN(t.value))throw this.astErrorOutput("Non-numeric literal not supported : "+t.value,t);e.push(t.value);var s=this.isState("in-get-call-parameters");return Number.isInteger(t.value)?s||e.push(".0"):s&&(e.pop(),e.push("int("),e.push(t.value),e.push(")")),e}},{key:"astBinaryExpression",value:function(t,e){var s=this.isState("in-get-call-parameters");return s&&(this.pushState("not-in-get-call-parameters"),e.push("int")),e.push("("),"%"===t.operator?(e.push("mod("),this.astGeneric(t.left,e),e.push(","),this.astGeneric(t.right,e),e.push(")")):"==="===t.operator?(this.astGeneric(t.left,e),e.push("=="),this.astGeneric(t.right,e)):"!=="===t.operator?(this.astGeneric(t.left,e),e.push("!="),this.astGeneric(t.right,e)):this.fixIntegerDivisionAccuracy&&"/"===t.operator?(e.push("div_with_int_check("),this.astGeneric(t.left,e),e.push(", "),this.astGeneric(t.right,e),e.push(")")):(this.astGeneric(t.left,e),e.push(t.operator),this.astGeneric(t.right,e)),e.push(")"),s&&this.popState("not-in-get-call-parameters"),e}},{key:"astIdentifierExpression",value:function(t,e){if("Identifier"!==t.type)throw this.astErrorOutput("IdentifierExpression - not an Identifier",t);var s=!this.isState("in-get-call-parameters");switch(t.name){case"gpu_threadX":s&&e.push("float("),e.push("threadId.x"),s&&e.push(")");break;case"gpu_threadY":s&&e.push("float("),e.push("threadId.y"),s&&e.push(")");break;case"gpu_threadZ":s&&e.push("float("),e.push("threadId.z"),s&&e.push(")");break;case"gpu_outputX":e.push("uOutputDim.x");break;case"gpu_outputY":e.push("uOutputDim.y");break;case"gpu_outputZ":e.push("uOutputDim.z");break;case"Infinity":e.push("3.402823466e+38");break;default:if(this.constants&&this.constants.hasOwnProperty(t.name))this.pushParameter(e,"constants_"+t.name);else{var r=this.getUserParamName(t.name);null!==r?this.pushParameter(e,"user_"+r):this.pushParameter(e,"user_"+t.name)}}return e}},{key:"astForStatement",value:function(t,e){if("ForStatement"!==t.type)throw this.astErrorOutput("Invalid for statment",t);if(t.test&&"BinaryExpression"===t.test.type){if("Identifier"===t.test.right.type&&"<"===t.test.operator&&!1===this.isIdentifierConstant(t.test.right.name)){if(this.loopMaxIterations||(console.warn("Warning: loopMaxIterations is not set! Using default of 1000 which may result in unintended behavior."),console.warn("Set loopMaxIterations or use a for loop of fixed length to silence this message.")),e.push("for ("),this.astGeneric(t.init,e),this.astGeneric(t.test.left,e),e.push(t.test.operator),e.push("LOOP_MAX"),e.push(";"),this.astGeneric(t.update,e),e.push(")"),e.push("{\n"),e.push("if ("),this.astGeneric(t.test.left,e),e.push(t.test.operator),this.astGeneric(t.test.right,e),e.push(") {\n"),"BlockStatement"===t.body.type)for(var s=0;s<t.body.body.length;s++)this.astGeneric(t.body.body[s],e);else this.astGeneric(t.body,e);return e.push("} else {\n"),e.push("break;\n"),e.push("}\n"),e.push("}\n"),e}var r=JSON.parse(JSON.stringify(t.init.declarations)),i=t.update.argument;if(!Array.isArray(r)||r.length<1)throw c(this.jsFunctionString),new Error("Error: Incompatible for loop declaration");if(r.length>1){for(var n=null,a=0;a<r.length;a++){var u=r[a];u.id.name===i.name?(n=u,r.splice(a,1)):(e.push("float "),this.astGeneric(u,e),e.push(";"))}e.push("for (float "),this.astGeneric(n,e),e.push(";")}else e.push("for ("),this.astGeneric(t.init,e);return this.astGeneric(t.test,e),e.push(";"),this.astGeneric(t.update,e),e.push(")"),this.astGeneric(t.body,e),e}throw this.astErrorOutput("Invalid for statement",t)}},{key:"astWhileStatement",value:function(t,e){if("WhileStatement"!==t.type)throw this.astErrorOutput("Invalid while statment",t);return e.push("for (float i = 0.0; i < LOOP_MAX; i++) {"),e.push("if ("),this.astGeneric(t.test,e),e.push(") {\n"),this.astGeneric(t.body,e),e.push("} else {\n"),e.push("break;\n"),e.push("}\n"),e.push("}\n"),e}},{key:"astDoWhileStatement",value:function(t,e){if("DoWhileStatement"!==t.type)throw this.astErrorOutput("Invalid while statment",t);return e.push("for (float i = 0.0; i < LOOP_MAX; i++) {"),this.astGeneric(t.body,e),e.push("if (!"),this.astGeneric(t.test,e),e.push(") {\n"),e.push("break;\n"),e.push("}\n"),e.push("}\n"),e}},{key:"astAssignmentExpression",value:function(t,e){if("%="!==t.operator)return this.astGeneric(t.left,e),e.push(t.operator),this.astGeneric(t.right,e),e;this.astGeneric(t.left,e),e.push("="),e.push("mod("),this.astGeneric(t.left,e),e.push(","),this.astGeneric(t.right,e),e.push(")")}},{key:"astEmptyStatement",value:function(t,e){return e}},{key:"astBlockStatement",value:function(t,e){e.push("{\n");for(var s=0;s<t.body.length;s++)this.astGeneric(t.body[s],e);return e.push("}\n"),e}},{key:"astExpressionStatement",value:function(t,e){return this.astGeneric(t.expression,e),e.push(";\n"),e}},{key:"astVariableDeclaration",value:function(t,e){for(var s=0;s<t.declarations.length;s++){var r=t.declarations[s];s>0&&e.push(",");var i=[];this.astGeneric(r,i),"getImage2D("===i[2]||"getImage3D("===i[2]?(0===s&&e.push("vec4 "),this.declarations[r.id.name]="vec4"):(0===s&&e.push("float "),this.declarations[r.id.name]="float"),e.push.apply(e,i)}return e.push(";"),e}},{key:"astVariableDeclarator",value:function(t,e){return this.astGeneric(t.id,e),null!==t.init&&(e.push("="),this.astGeneric(t.init,e)),e}},{key:"astIfStatement",value:function(t,e){return e.push("if ("),this.astGeneric(t.test,e),e.push(")"),"BlockStatement"===t.consequent.type?this.astGeneric(t.consequent,e):(e.push(" {\n"),this.astGeneric(t.consequent,e),e.push("\n}\n")),t.alternate&&(e.push("else "),"BlockStatement"===t.alternate.type?this.astGeneric(t.alternate,e):(e.push(" {\n"),this.astGeneric(t.alternate,e),e.push("\n}\n"))),e}},{key:"astBreakStatement",value:function(t,e){return e.push("break;\n"),e}},{key:"astContinueStatement",value:function(t,e){return e.push("continue;\n"),e}},{key:"astLogicalExpression",value:function(t,e){return e.push("("),this.astGeneric(t.left,e),e.push(t.operator),this.astGeneric(t.right,e),e.push(")"),e}},{key:"astUpdateExpression",value:function(t,e){return t.prefix?(e.push(t.operator),this.astGeneric(t.argument,e)):(this.astGeneric(t.argument,e),e.push(t.operator)),e}},{key:"astUnaryExpression",value:function(t,e){return t.prefix?(e.push(t.operator),this.astGeneric(t.argument,e)):(this.astGeneric(t.argument,e),e.push(t.operator)),e}},{key:"astThisExpression",value:function(t,e){return e.push("this"),e}},{key:"astMemberExpression",value:function(t,e){if(c("[in] astMemberExpression "+t.object.type),t.computed)if("Identifier"===t.object.type||"MemberExpression"===t.object.type&&t.object.object.object&&"ThisExpression"===t.object.object.object.type&&"constants"===t.object.object.property.name){var s=t.object.name,r=this.functionName||"kernel",i=!1;if(this.paramNames){var n=this.paramNames.indexOf(s);n>=0&&"float"===this.paramTypes[n]&&(i=!0)}if(c("- astMemberExpression "+s+" "+r),i)this.astGeneric(t.object,e),e.push("[int("),this.astGeneric(t.property,e),e.push(")]");else{var a=this.isState("in-get-call-parameters"),u=this.isState("multi-member-expression");u&&this.popState("multi-member-expression"),this.pushState("not-in-get-call-parameters");var o=null;switch(t.object.name?o=this.getParamType(t.object.name):t.object&&t.object.object&&t.object.object.object&&"ThisExpression"===t.object.object.object.type&&(o=this.getConstantType(t.object.property.name)),o){case"vec4":this.astGeneric(t.object,e),e.push("["),e.push(t.property.raw),e.push("]"),u&&this.popState("not-in-get-call-parameters");break;case"HTMLImageArray":e.push("getImage3D("),this.astGeneric(t.object,e),e.push(", ivec2("),this.astGeneric(t.object,e),e.push("Size[0],"),this.astGeneric(t.object,e),e.push("Size[1]), ivec3("),this.astGeneric(t.object,e),e.push("Dim[0],"),this.astGeneric(t.object,e),e.push("Dim[1],"),this.astGeneric(t.object,e),e.push("Dim[2]"),e.push("), "),this.popState("not-in-get-call-parameters"),this.pushState("in-get-call-parameters"),this.astGeneric(t.property,e),u||this.popState("in-get-call-parameters"),e.push(")");break;case"HTMLImage":e.push("getImage2D("),this.astGeneric(t.object,e),e.push(", ivec2("),this.astGeneric(t.object,e),e.push("Size[0],"),this.astGeneric(t.object,e),e.push("Size[1]), ivec3("),this.astGeneric(t.object,e),e.push("Dim[0],"),this.astGeneric(t.object,e),e.push("Dim[1],"),this.astGeneric(t.object,e),e.push("Dim[2]"),e.push("), "),this.popState("not-in-get-call-parameters"),this.pushState("in-get-call-parameters"),this.astGeneric(t.property,e),u||this.popState("in-get-call-parameters"),e.push(")");break;default:a&&e.push("int("),e.push("get("),this.astGeneric(t.object,e),e.push(", ivec2("),this.astGeneric(t.object,e),e.push("Size[0],"),this.astGeneric(t.object,e),e.push("Size[1]), ivec3("),this.astGeneric(t.object,e),e.push("Dim[0],"),this.astGeneric(t.object,e),e.push("Dim[1],"),this.astGeneric(t.object,e),e.push("Dim[2]"),e.push("), "),this.astGeneric(t.object,e),e.push("BitRatio"),e.push(", "),this.popState("not-in-get-call-parameters"),this.pushState("in-get-call-parameters"),this.astGeneric(t.property,e),u||this.popState("in-get-call-parameters"),e.push(")"),a&&e.push(")")}}}else{c("- astMemberExpression obj:",t.object);this.states.length;var p=this.isState("in-get-call-parameters");p||this.pushState("multi-member-expression"),this.astGeneric(t.object,e),this.isState("multi-member-expression")&&this.popState("multi-member-expression");var l=!p&&this.isState("in-get-call-parameters"),f=e.pop();e.push(","),c("- astMemberExpression prop:",t.property);var m=this.isState("should-pop-in-get-call-parameters");m&&this.popState("should-pop-in-get-call-parameters"),this.astGeneric(t.property,e),e.push(f),l?this.pushState("should-pop-in-get-call-parameters"):m&&this.popState("in-get-call-parameters")}else{var b=this.astMemberExpressionUnroll(t),y=b.toLowerCase();c("- astMemberExpression unrolled:",b),0===b.indexOf(h)&&(b="constants_"+b.slice(h.length));var g=!this.isState("in-get-call-parameters");switch(y){case"this.thread.x":g&&e.push("float("),e.push("threadId.x"),g&&e.push(")");break;case"this.thread.y":g&&e.push("float("),e.push("threadId.y"),g&&e.push(")");break;case"this.thread.z":g&&e.push("float("),e.push("threadId.z"),g&&e.push(")");break;case"this.output.x":e.push(this.output[0]+".0");break;case"this.output.y":e.push(this.output[1]+".0");break;case"this.output.z":e.push(this.output[2]+".0");break;default:t.object&&t.object.name&&this.declarations[t.object.name]&&e.push("user_"),e.push(b)}}return c("[out] astMemberExpression "+t.object.type),e}},{key:"astSequenceExpression",value:function(t,e){for(var s=0;s<t.expressions.length;s++)s>0&&e.push(","),this.astGeneric(t.expressions,e);return e}},{key:"astCallExpression",value:function(t,e){if(t.callee){var s=this.astMemberExpressionUnroll(t.callee);0===s.indexOf(a)&&(s=s.slice(a.length)),0===s.indexOf(u)&&(s=s.slice(u.length)),"atan2"===s&&(s="atan"),this.calledFunctions.indexOf(s)<0&&this.calledFunctions.push(s),this.hasOwnProperty("funcName")||(this.calledFunctionsArguments[s]=[]);var r=[];this.calledFunctionsArguments[s].push(r),e.push(s),e.push("(");for(var i=0;i<t.arguments.length;++i){var n=t.arguments[i];if(i>0&&e.push(", "),this.astGeneric(n,e),"Identifier"===n.type){var h=this.paramNames.indexOf(n.name);-1===h?r.push(null):r.push({name:n.name,type:this.paramTypes[h]})}else r.push(null)}return e.push(")"),e}throw this.astErrorOutput("Unknown CallExpression",t)}},{key:"astArrayExpression",value:function(t,e){var s=t.elements.length;e.push("float["+s+"](");for(var r=0;r<s;++r){r>0&&e.push(", ");var i=t.elements[r];this.astGeneric(i,e)}return e.push(")"),e}},{key:"getFunctionPrototypeString",value:function(){return this.webGlFunctionPrototypeString?this.webGlFunctionPrototypeString:this.webGlFunctionPrototypeString=this.generate()}},{key:"build",value:function(){return this.getFunctionPrototypeString().length>0}}],[{key:"astFunctionPrototype",value:function(t,e){if(this.isRootKernel||this.isSubKernel)return e;e.push(this.returnType),e.push(" "),e.push(this.functionName),e.push("(");for(var s=0;s<this.paramNames.length;++s)s>0&&e.push(", "),e.push(this.paramTypes[s]),e.push(" "),e.push("user_"),e.push(this.paramNames[s]);return e.push(");\n"),e}}]),p}();
...
"use strict";var t=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}();function e(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function r(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function n(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var s=require("../web-gl/function-node"),a="this.constants.",u=/decode32\(\s+encode32\(/g,i=/encode32\(\s+decode32\(/g;function o(t){return t.replace(u,"((").replace(i,"((")}module.exports=function(a){function u(){return e(this,u),r(this,(u.__proto__||Object.getPrototypeOf(u)).apply(this,arguments))}return n(u,s),t(u,[{key:"generate",value:function(){return this.debug&&console.log(this),this.prototypeOnly?u.astFunctionPrototype(this.getJsAST(),[],this).join("").trim():(this.functionStringArray=this.astGeneric(this.getJsAST(),[],this),this.functionString=o(this.functionStringArray.join("").trim()),this.functionString)}},{key:"astFunctionExpression",value:function(t,e){if(this.isRootKernel?(e.push("void"),this.kernalAst=t):e.push(this.returnType),e.push(" "),e.push(this.functionName),e.push("("),!this.isRootKernel)for(var r=0;r<this.paramNames.length;++r){var n=this.paramNames[r];switch(r>0&&e.push(", "),this.getParamType(n)){case"Texture":case"Input":case"Array":case"HTMLImage":e.push("sampler2D");break;default:e.push("float")}e.push(" "),e.push("user_"),e.push(n)}e.push(") {\n");for(var s=0;s<t.body.body.length;++s)this.astGeneric(t.body.body[s],e),e.push("\n");return e.push("}\n"),e}},{key:"astIdentifierExpression",value:function(t,e){if("Identifier"!==t.type)throw this.astErrorOutput("IdentifierExpression - not an Identifier",t);var r=!this.isState("in-get-call-parameters");switch(t.name){case"gpu_threadX":r&&e.push("float("),e.push("threadId.x"),r&&e.push(")");break;case"gpu_threadY":r&&e.push("float("),e.push("threadId.y"),r&&e.push(")");break;case"gpu_threadZ":r&&e.push("float("),e.push("threadId.z"),r&&e.push(")");break;case"gpu_outputX":e.push("uOutputDim.x");break;case"gpu_outputY":e.push("uOutputDim.y");break;case"gpu_outputZ":e.push("uOutputDim.z");break;case"Infinity":e.push("intBitsToFloat(2139095039)");break;default:if(this.constants&&this.constants.hasOwnProperty(t.name))this.pushParameter(e,"constants_"+t.name);else{var n=this.getUserParamName(t.name);null!==n?this.pushParameter(e,"user_"+n):this.pushParameter(e,"user_"+t.name)}}return e}}]),u}();
...
"use strict";var t=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}();function e(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function i(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function r(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var s=require("../web-gl/kernel"),a=require("../../core/utils"),n=require("../../core/texture"),u=require("./shader-frag"),o=require("./shader-vert");module.exports=function(h){function T(){return e(this,T),i(this,(T.__proto__||Object.getPrototypeOf(T)).apply(this,arguments))}return r(T,s),t(T,[{key:"initWebGl",value:function(){return a.initWebGl2(this.getCanvas())}},{key:"validateOptions",value:function(){var t=a.isFloatReadPixelsSupportedWebGL2();if(!0===this.floatOutput&&!0!==this.floatOutputForce&&!t)throw new Error("Float texture outputs are not supported on this browser");void 0===this.floatTextures&&(this.floatTextures=!0,this.floatOutput=t);var e=a.hasIntegerDivisionAccuracyBug();if(null===this.fixIntegerDivisionAccuracy?this.fixIntegerDivisionAccuracy=e:this.fixIntegerDivisionAccuracy&&!e&&(this.fixIntegerDivisionAccuracy=!1),a.checkOutput(this.output),!this.output||0===this.output.length){if(1!==arguments.length)throw new Error("Auto output only supported for kernels with only one input");var i=a.getArgumentType(arguments[0]);if("Array"===i)this.output=a.getDimensions(i);else{if("Texture"!==i)throw new Error("Auto output not supported for input type: "+i);this.output=arguments[0].output}}if(this.texSize=a.dimToTexSize({floatTextures:this.floatTextures,floatOutput:this.floatOutput},this.output,!0),this.graphical){if(2!==this.output.length)throw new Error("Output must have 2 dimensions on graphical mode");this.floatOutput&&(this.floatOutput=!1,console.warn("Cannot use graphical mode and float output at the same time")),this.texSize=a.clone(this.output)}else void 0===this.floatOutput&&(this.floatOutput=!0);(this.floatOutput||this.floatOutputForce)&&this._webGl.getExtension("EXT_color_buffer_float")}},{key:"run",value:function(){null===this.program&&this.build.apply(this,arguments);var t=this.paramNames,e=this.paramTypes,i=this.texSize,r=this._webGl;r.useProgram(this.program),r.scissor(0,0,i[0],i[1]),this.hardcodeConstants||(this.setUniform3iv("uOutputDim",new Int32Array(this.threadDim)),this.setUniform2iv("uTexSize",i)),this.setUniform2f("ratio",i[0]/this.maxTexSize[0],i[1]/this.maxTexSize[1]),this.argumentsLength=0;for(var s=0;s<t.length;s++)this._addArgument(arguments[s],e[s],t[s]);if(this.graphical)return r.bindRenderbuffer(r.RENDERBUFFER,null),r.bindFramebuffer(r.FRAMEBUFFER,null),void r.drawArrays(r.TRIANGLE_STRIP,0,4);r.bindFramebuffer(r.FRAMEBUFFER,this.framebuffer),this.outputImmutable&&this._setupOutputTexture();var a=this.outputTexture;if(null!==this.subKernelOutputVariableNames&&(this.outputImmutable&&(this.subKernelOutputTextures=[],this._setupSubOutputTextures(this.subKernelOutputVariableNames.length)),r.drawBuffers(this.drawBuffersMap)),r.drawArrays(r.TRIANGLE_STRIP,0,4),null!==this.subKernelOutputTextures){if(null!==this.subKernels){var u=[];u.result=this.renderOutput(a);for(var o=0;o<this.subKernels.length;o++)u.push(new n(this.subKernelOutputTextures[o],i,this.threadDim,this.output,this._webGl));return u}if(null!==this.subKernelProperties){var h={result:this.renderOutput(a)},T=0;for(var E in this.subKernelProperties)this.subKernelProperties.hasOwnProperty(E)&&(h[E]=new n(this.subKernelOutputTextures[T],i,this.threadDim,this.output,this._webGl),T++);return h}}return this.renderOutput(a)}},{key:"getOutputTexture",value:function(){return this.outputTexture}},{key:"_setupOutputTexture",value:function(){var t=this._webGl,e=this.texSize,i=this.outputTexture=this._webGl.createTexture();t.activeTexture(t.TEXTURE0+this.constantsLength+this.paramNames.length),t.bindTexture(t.TEXTURE_2D,i),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.NEAREST),this.floatOutput?t.texImage2D(t.TEXTURE_2D,0,t.RGBA32F,e[0],e[1],0,t.RGBA,t.FLOAT,null):t.texImage2D(t.TEXTURE_2D,0,t.RGBA,e[0],e[1],0,t.RGBA,t.UNSIGNED_BYTE,null),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0)}},{key:"_setupSubOutputTextures",value:function(t){for(var e=this._webGl,i=this.texSize,r=this.drawBuffersMap=[e.COLOR_ATTACHMENT0],s=this.subKernelOutputTextures=[],a=0;a<t;a++){var n=this._webGl.createTexture();s.push(n),r.push(e.COLOR_ATTACHMENT0+a+1),e.activeTexture(e.TEXTURE0+this.constantsLength+this.paramNames.length+a),e.bindTexture(e.TEXTURE_2D,n),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),this.floatOutput?e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,i[0],i[1],0,e.RGBA,e.FLOAT,null):e.texImage2D(e.TEXTURE_2D,0,e.RGBA,i[0],i[1],0,e.RGBA,e.UNSIGNED_BYTE,null),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+a+1,e.TEXTURE_2D,n,0)}}},{key:"_addArgument",value:function(t,e,i){var r=this._webGl,s=this.getArgumentTexture(i);switch(t instanceof n&&(e="Texture"),e){case"Array":var u=a.getDimensions(t,!0),o=a.dimToTexSize({floatTextures:this.floatTextures,floatOutput:this.floatOutput},u);r.activeTexture(r.TEXTURE0+this.constantsLength+this.argumentsLength),r.bindTexture(r.TEXTURE_2D,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST);var h=o[0]*o[1],T=this._formatArrayTransfer(t,h),E=T.valuesFlat,_=T.bitRatio,l=void 0;this.floatTextures?r.texImage2D(r.TEXTURE_2D,0,r.RGBA32F,o[0],o[1],0,r.RGBA,r.FLOAT,E):(l=new Uint8Array(E.buffer),r.texImage2D(r.TEXTURE_2D,0,r.RGBA,o[0]/_,o[1],0,r.RGBA,r.UNSIGNED_BYTE,l)),this.hardcodeConstants||(this.setUniform3iv("user_"+i+"Dim",u),this.setUniform2iv("user_"+i+"Size",o)),this.setUniform1i("user_"+i+"BitRatio",_),this.setUniform1i("user_"+i,this.argumentsLength);break;case"Integer":case"Float":this.setUniform1f("user_"+i,t);break;case"Input":var R=t.size,f=a.dimToTexSize({floatTextures:this.floatTextures,floatOutput:this.floatOutput},R);r.activeTexture(r.TEXTURE0+this.constantsLength+this.argumentsLength),r.bindTexture(r.TEXTURE_2D,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST);var p=f[0]*f[1],m=this._formatArrayTransfer(t.value,p),c=m.valuesFlat,g=m.bitRatio;if(this.floatTextures)r.texImage2D(r.TEXTURE_2D,0,r.RGBA32F,f[0],f[1],0,r.RGBA,r.FLOAT,inputArray);else{var A=new Uint8Array(c.buffer);r.texImage2D(r.TEXTURE_2D,0,r.RGBA,f[0]/g,f[1],0,r.RGBA,r.UNSIGNED_BYTE,A)}this.hardcodeConstants||(this.setUniform3iv("user_"+i+"Dim",R),this.setUniform2iv("user_"+i+"Size",f)),this.setUniform1i("user_"+i+"BitRatio",g),this.setUniform1i("user_"+i,this.argumentsLength);break;case"HTMLImage":var U=t,x=[U.width,U.height,1],d=[U.width,U.height];r.activeTexture(r.TEXTURE0+this.constantsLength+this.argumentsLength),r.bindTexture(r.TEXTURE_2D,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!0);var D=r.RGBA,v=r.RGBA,b=r.UNSIGNED_BYTE;r.texImage2D(r.TEXTURE_2D,0,D,v,b,U),this.setUniform3iv("user_"+i+"Dim",x),this.setUniform2iv("user_"+i+"Size",d),this.setUniform1i("user_"+i,this.argumentsLength);break;case"HTMLImageArray":var S=t,X=[S[0].width,S[0].height,S.length],I=[S[0].width,S[0].height];r.activeTexture(r.TEXTURE0+this.constantsLength+this.argumentsLength),r.bindTexture(r.TEXTURE_2D_ARRAY,s),r.texParameteri(r.TEXTURE_2D_ARRAY,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D_ARRAY,r.TEXTURE_MIN_FILTER,r.NEAREST),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!0);var L=r.RGBA,O=S[0].width,P=S[0].height,y=S.length,G=r.RGBA,N=r.UNSIGNED_BYTE;r.texImage3D(r.TEXTURE_2D_ARRAY,0,L,O,P,y,0,G,N,null);for(var F=0;F<S.length;F++){r.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,F,S[F].width,S[F].height,1,G,N,S[F])}this.setUniform3iv("user_"+i+"Dim",X),this.setUniform2iv("user_"+i+"Size",I),this.setUniform1i("user_"+i,this.argumentsLength);break;case"Texture":var B=t,w=B.dimensions,M=B.size;r.activeTexture(r.TEXTURE0+this.constantsLength+this.argumentsLength),r.bindTexture(r.TEXTURE_2D,B.texture),this.setUniform3iv("user_"+i+"Dim",w),this.setUniform2iv("user_"+i+"Size",M),this.setUniform1i("user_"+i+"BitRatio",1),this.setUniform1i("user_"+i,this.argumentsLength);break;default:throw new Error("Input type not supported (WebGL): "+t)}this.argumentsLength++}},{key:"_getMainConstantsString",value:function(){var t=[];if(this.constants)for(var e in this.constants)if(this.constants.hasOwnProperty(e)){var i=this.constants[e],r=a.getArgumentType(i);switch(r){case"Integer":t.push("const float constants_"+e+" = "+parseInt(i)+".0");break;case"Float":t.push("const float constants_"+e+" = "+parseFloat(i));break;case"Array":case"Input":case"HTMLImage":case"Texture":t.push("uniform highp sampler2D constants_"+e,"uniform highp ivec2 constants_"+e+"Size","uniform highp ivec3 constants_"+e+"Dim","uniform highp int constants_"+e+"BitRatio");break;case"HTMLImageArray":t.push("uniform highp sampler2DArray constants_"+e,"uniform highp ivec2 constants_"+e+"Size","uniform highp ivec3 constants_"+e+"Dim","uniform highp int constants_"+e+"BitRatio");break;default:throw new Error("Unsupported constant "+e+" type "+r)}}return this._linesToString(t)}},{key:"_addConstant",value:function(t,e,i){var r=this._webGl,s=this.getArgumentTexture(i);switch(t instanceof n&&(e="Texture"),e){case"Array":var u=a.getDimensions(t,!0),o=a.dimToTexSize({floatTextures:this.floatTextures,floatOutput:this.floatOutput},u);r.activeTexture(r.TEXTURE0+this.constantsLength),r.bindTexture(r.TEXTURE_2D,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST);var h=o[0]*o[1],T=this._formatArrayTransfer(t,h),E=T.valuesFlat,_=T.bitRatio,l=void 0;this.floatTextures?r.texImage2D(r.TEXTURE_2D,0,r.RGBA,o[0],o[1],0,r.RGBA,r.FLOAT,E):(l=new Uint8Array(E.buffer),r.texImage2D(r.TEXTURE_2D,0,r.RGBA,o[0]/_,o[1],0,r.RGBA,r.UNSIGNED_BYTE,l)),this.hardcodeConstants||(this.setUniform3iv("constants_"+i+"Dim",u),this.setUniform2iv("constants_"+i+"Size",o)),this.setUniform1i("constants_"+i+"BitRatio",_),this.setUniform1i("constants_"+i,this.constantsLength);break;case"Integer":case"Float":this.setUniform1f("constants_"+i,t);break;case"Input":var R=t.size,f=a.dimToTexSize({floatTextures:this.floatTextures,floatOutput:this.floatOutput},R);r.activeTexture(r.TEXTURE0+this.constantsLength),r.bindTexture(r.TEXTURE_2D,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST);var p=f[0]*f[1],m=this._formatArrayTransfer(t.value,p),c=m.valuesFlat,g=m.bitRatio;if(this.floatTextures)r.texImage2D(r.TEXTURE_2D,0,r.RGBA32F,f[0],f[1],0,r.RGBA,r.FLOAT,inputArray);else{var A=new Uint8Array(c.buffer);r.texImage2D(r.TEXTURE_2D,0,r.RGBA,f[0]/g,f[1],0,r.RGBA,r.UNSIGNED_BYTE,A)}this.hardcodeConstants||(this.setUniform3iv("constants_"+i+"Dim",R),this.setUniform2iv("constants_"+i+"Size",f)),this.setUniform1i("constants_"+i+"BitRatio",g),this.setUniform1i("constants_"+i,this.constantsLength);break;case"HTMLImage":var U=t,x=[U.width,U.height,1],d=[U.width,U.height];r.activeTexture(r.TEXTURE0+this.constantsLength),r.bindTexture(r.TEXTURE_2D,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!0);var D=r.RGBA,v=r.RGBA,b=r.UNSIGNED_BYTE;r.texImage2D(r.TEXTURE_2D,0,D,v,b,U),this.setUniform3iv("constants_"+i+"Dim",x),this.setUniform2iv("constants_"+i+"Size",d),this.setUniform1i("constants_"+i,this.constantsLength);break;case"HTMLImageArray":var S=t,X=[S[0].width,S[0].height,S.length],I=[S[0].width,S[0].height];r.activeTexture(r.TEXTURE0+this.constantsLength),r.bindTexture(r.TEXTURE_2D_ARRAY,s),r.texParameteri(r.TEXTURE_2D_ARRAY,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D_ARRAY,r.TEXTURE_MIN_FILTER,r.NEAREST),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!0);var L=r.RGBA,O=S[0].width,P=S[0].height,y=S.length,G=r.RGBA,N=r.UNSIGNED_BYTE;r.texImage3D(r.TEXTURE_2D_ARRAY,0,L,O,P,y,0,G,N,null);for(var F=0;F<S.length;F++){r.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,F,S[F].width,S[F].height,1,G,N,S[F])}this.setUniform3iv("constants_"+i+"Dim",X),this.setUniform2iv("constants_"+i+"Size",I),this.setUniform1i("constants_"+i,this.constantsLength);break;case"Texture":var B=t,w=B.dimensions,M=B.size;r.activeTexture(r.TEXTURE0+this.constantsLength),r.bindTexture(r.TEXTURE_2D,B.texture),this.setUniform3iv("constants_"+i+"Dim",w),this.setUniform2iv("constants_"+i+"Size",M),this.setUniform1i("constants_"+i+"BitRatio",1),this.setUniform1i("constants_"+i,this.constantsLength);break;default:throw new Error("Input type not supported (WebGL): "+t)}}},{key:"_getGetResultString",value:function(){return this.floatTextures?"  return texel[channel];":"  return decode(texel, x, bitRatio);"}},{key:"_getHeaderString",value:function(){return""}},{key:"_getTextureCoordinate",value:function(){var t=this.subKernelOutputVariableNames;return null===t||t.length<1?"in highp vec2 vTexCoord;\n":"out highp vec2 vTexCoord;\n"}},{key:"_getMainParamsString",value:function(t){for(var e=[],i=this.paramTypes,r=this.paramNames,s=0;s<r.length;s++){var n=t[s],u=r[s],o=i[s];if(this.hardcodeConstants)if("Array"===o||"Texture"===o){var h=a.getDimensions(n,!0),T=a.dimToTexSize({floatTextures:this.floatTextures,floatOutput:this.floatOutput},h);e.push("uniform highp sampler2D user_"+u,"highp ivec2 user_"+u+"Size = ivec2("+T[0]+", "+T[1]+")","highp ivec3 user_"+u+"Dim = ivec3("+h[0]+", "+h[1]+", "+h[2]+")","uniform highp int user_"+u+"BitRatio"),"Array"===o&&e.push("uniform highp int user_"+u+"BitRatio")}else"Integer"===o?e.push("highp float user_"+u+" = "+n+".0"):"Float"===o&&e.push("highp float user_"+u+" = "+n);else"Array"===o||"Texture"===o||"Input"===o||"HTMLImage"===o?(e.push("uniform highp sampler2D user_"+u,"uniform highp ivec2 user_"+u+"Size","uniform highp ivec3 user_"+u+"Dim"),"HTMLImage"!==o&&e.push("uniform highp int user_"+u+"BitRatio")):"HTMLImageArray"===o?e.push("uniform highp sampler2DArray user_"+u,"uniform highp ivec2 user_"+u+"Size","uniform highp ivec3 user_"+u+"Dim"):"Integer"!==o&&"Float"!==o||e.push("uniform float user_"+u)}return this._linesToString(e)}},{key:"_getKernelString",value:function(){var t=[],e=this.subKernelOutputVariableNames;if(null!==e){t.push("float kernelResult = 0.0"),t.push("layout(location = 0) out vec4 data0");for(var i=0;i<e.length;i++)t.push("float "+e[i]+" = 0.0","layout(location = "+(i+1)+") out vec4 data"+(i+1))}else t.push("out vec4 data0"),t.push("float kernelResult = 0.0");return this._linesToString(t)+this.functionBuilder.getPrototypeString("kernel")}},{key:"_getMainResultString",value:function(){var t=this.subKernelOutputVariableNames,e=[];if(this.floatOutput&&e.push("  index *= 4"),this.graphical)e.push("  threadId = indexTo3D(index, uOutputDim)","  kernel()","  data0 = actualColor");else if(this.floatOutput)for(var i=["r","g","b","a"],r=0;r<i.length;++r){if(e.push("  threadId = indexTo3D(index, uOutputDim)"),e.push("  kernel()"),t){e.push("  data0."+i[r]+" = kernelResult");for(var s=0;s<t.length;++s)e.push("  data"+(s+1)+"."+i[r]+" = "+t[s])}else e.push("  data0."+i[r]+" = kernelResult");r<i.length-1&&e.push("  index += 1")}else if(null!==t){e.push("  threadId = indexTo3D(index, uOutputDim)"),e.push("  kernel()"),e.push("  data0 = encode32(kernelResult)");for(var a=0;a<t.length;a++)e.push("  data"+(a+1)+" = encode32("+t[a]+")")}else e.push("  threadId = indexTo3D(index, uOutputDim)","  kernel()","  data0 = encode32(kernelResult)");return this._linesToString(e)}},{key:"_addKernels",value:function(){var t=this,e=this.functionBuilder;this._webGl;e.addFunctions(this.functions,{constants:this.constants,output:this.output}),e.addNativeFunctions(this.nativeFunctions),e.addKernel(this.fnString,{prototypeOnly:!1,constants:this.constants,output:this.output,debug:this.debug,loopMaxIterations:this.loopMaxIterations,paramNames:this.paramNames,paramTypes:this.paramTypes,constantTypes:this.constantTypes,fixIntegerDivisionAccuracy:this.fixIntegerDivisionAccuracy}),null!==this.subKernels?(this.subKernelOutputTextures=[],this.subKernelOutputVariableNames=[],this.subKernels.forEach(function(e){return t._addSubKernel(e)})):null!==this.subKernelProperties&&(this.subKernelOutputTextures=[],this.subKernelOutputVariableNames=[],Object.keys(this.subKernelProperties).forEach(function(e){return t._addSubKernel(t.subKernelProperties[e])}))}},{key:"_getFragShaderString",value:function(t){return null!==this.compiledFragShaderString?this.compiledFragShaderString:this.compiledFragShaderString=this._replaceArtifacts(this.constructor.fragShaderString,this._getFragShaderArtifactMap(t))}},{key:"_getVertShaderString",value:function(t){return null!==this.compiledVertShaderString?this.compiledVertShaderString:this.compiledVertShaderString=this.constructor.vertShaderString}}],[{key:"fragShaderString",get:function(){return u}},{key:"vertShaderString",get:function(){return o}}]),T}();
...
"use strict";console.log("Testing");var e=require("./core/gpu"),n=require("./core/alias"),r=require("./core/utils"),u=require("./core/input"),i=require("./core/texture"),c=require("./backend/cpu/function-builder"),o=require("./backend/cpu/function-node"),d=require("./backend/cpu/kernel"),b=require("./backend/cpu/runner"),l=require("./backend/web-gl/function-builder"),t=require("./backend/web-gl/function-node"),a=require("./backend/web-gl/kernel"),q=require("./backend/web-gl/runner"),k=require("./backend/web-gl2/function-builder"),w=require("./backend/web-gl2/function-node"),f=require("./backend/web-gl2/kernel"),g=require("./backend/web-gl2/runner");e.alias=n,e.utils=r,e.Texture=i,e.Input=u,e.input=function(e,n){return new u(e,n)},e.CPUFunctionBuilder=c,e.CPUFunctionNode=o,e.CPUKernel=d,e.CPURunner=b,e.WebGLFunctionBuilder=l,e.WebGLFunctionNode=t,e.WebGLKernel=a,e.WebGLRunner=q,e.WebGL2FunctionBuilder=k,e.WebGL2FunctionNode=w,e.WebGL2Kernel=f,e.WebGL2Runner=g,"undefined"!=typeof module&&(module.exports=e),"undefined"!=typeof window&&(window.GPU=e);
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.setup=n,exports.teardown=o,exports.makeKernel=p,exports.kernelInput=l;var e=require("gpu.js"),t=u(e);function u(e){return e&&e.__esModule?e:{default:e}}var r=null;function n(e){r=e}function o(){r=null}function p(e,u){return null===r&&n(new t.default({mode:"cpu"})),u.hasOwnProperty("map")?r.createKernelMap(u.map,e,u).setOutputToTexture(!0):r.createKernel(e,u).setOutputToTexture(!0)}function l(e,u){return t.default.input(e,u)}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Operator=exports.Modifier=exports.Model=exports.Filter=exports.Internal=exports.Activation=void 0;var t=require("./base"),e=o(t);function o(t){return t&&t.__esModule?t:{default:t}}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function n(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function i(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var p=exports.Activation=function(t){function o(){return r(this,o),n(this,(o.__proto__||Object.getPrototypeOf(o)).apply(this,arguments))}return i(o,e.default),o}(),u=exports.Internal=function t(){r(this,t)},s=exports.Filter=function(t){function o(){return r(this,o),n(this,(o.__proto__||Object.getPrototypeOf(o)).apply(this,arguments))}return i(o,e.default),o}(),f=exports.Model=function(t){function o(){return r(this,o),n(this,(o.__proto__||Object.getPrototypeOf(o)).apply(this,arguments))}return i(o,e.default),o}(),c=exports.Modifier=function(t){function o(){return r(this,o),n(this,(o.__proto__||Object.getPrototypeOf(o)).apply(this,arguments))}return i(o,e.default),o}(),a=exports.Operator=function(t){function o(){return r(this,o),n(this,(o.__proto__||Object.getPrototypeOf(o)).apply(this,arguments))}return i(o,e.default),o}();
},{"./base":"kIeX"}],"q7CK":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}(),e=function t(e,i,r){null===e&&(e=Function.prototype);var n=Object.getOwnPropertyDescriptor(e,i);if(void 0===n){var o=Object.getPrototypeOf(e);return null===o?void 0:t(o,i,r)}if("value"in n)return n.value;var a=n.get;return void 0!==a?a.call(r):void 0};exports.predict=p;var i=require("../utilities/kernel"),r=require("../utilities/zeros-2d"),n=a(r),o=require("./types");function a(t){return t&&t.__esModule?t:{default:t}}function u(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function h(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function p(t,e){return t[this.thread.y][this.thread.x]+e[this.thread.y][this.thread.x]}var l=function(r){function a(t,e){u(this,a);var i=h(this,(a.__proto__||Object.getPrototypeOf(a)).call(this));return i.inputLayer1=t,i.inputLayer2=e,i.width=i.inputLayer1.width,i.height=i.inputLayer1.height,i.validate(),i.weights=(0,n.default)(i.width,i.height),i.deltas=(0,n.default)(i.width,i.height),i}return s(a,o.Operator),t(a,[{key:"validate",value:function(){if(e(a.prototype.__proto__||Object.getPrototypeOf(a.prototype),"validate",this).call(this),this.inputLayer1.width!==this.inputLayer2.width)throw new Error("Layer width mismatch of "+this.inputLayer1.width+" and "+this.inputLayer2.width);if(this.inputLayer1.height!==this.inputLayer2.height)throw new Error("Layer height mismatch of "+this.inputLayer1.height+" and "+this.inputLayer2.height)}},{key:"setupKernels",value:function(){this.predictKernel=(0,i.makeKernel)(p,{output:[this.width,this.height]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer1.weights,this.inputLayer2.weights)}},{key:"compare",value:function(){this.inputLayer1.deltas=this.deltas,this.inputLayer2.deltas=this.deltas}}]),a}();exports.default=l;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,i){for(var e=0;e<i.length;e++){var s=i[e];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}return function(i,e,s){return e&&t(i.prototype,e),s&&t(i,s),i}}();exports.predict=y,exports.compareFilters=x,exports.getCompareFilterDeltasIndexStart=v,exports.getCompareFilterDeltasIndexStop=m,exports.getCompareFilterInputIndexStart=b,exports.getCompareFilterInputIndexStop=w,exports.compareInputs=X,exports.compareBiases=H;var i=require("../utilities/kernel"),e=require("../utilities/layer-setup"),s=require("./types"),n=require("../utilities/randos"),r=p(n),h=require("../utilities/randos-3d"),a=p(h),d=require("../utilities/zeros-3d"),o=p(d),u=require("../utilities/values"),l=p(u);function p(t){return t&&t.__esModule?t:{default:t}}function f(t,i){if(!(t instanceof i))throw new TypeError("Cannot call a class as a function")}function c(t,i){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!i||"object"!=typeof i&&"function"!=typeof i?t:i}function g(t,i){if("function"!=typeof i&&null!==i)throw new TypeError("Super expression must either be null or a function, not "+typeof i);t.prototype=Object.create(i&&i.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),i&&(Object.setPrototypeOf?Object.setPrototypeOf(t,i):t.__proto__=i)}function y(t,i,e){for(var s=this.thread.x/this.output.x*this.constants.inputWidth*this.constants.strideX-this.constants.paddingX,n=this.thread.y/this.output.y*this.constants.inputHeight*this.constants.strideY-this.constants.paddingY,r=0,h=0;h<this.constants.filterHeight;h++)for(var a=h+n,d=0;d<this.constants.filterWidth;d++){var o=d+s;if(a>=0&&a<this.constants.inputHeight&&o>=0&&o<this.constants.inputWidth)for(var u=0;u<this.constants.inputDepth;u++)for(var l=0;l<this.constants.filterCount;l++)r+=i[l][h][d]*t[u][a][o],console.log("filter ",l,h,d,"  input ",u,a,o,"  output ",this.thread.z,this.thread.y,this.thread.x)}return r+e[this.thread.z]}function x(t,i,e){for(var s=b(this.thread.x,this.constants.paddingX),n=b(this.thread.y,this.constants.paddingY),r=(w(this.thread.x,this.constants.paddingX,this.constants.deltaWidth,this.constants.inputWidth),w(this.thread.y,this.constants.paddingY,this.constants.deltaHeight,this.constants.inputHeight),v(this.thread.y,this.constants.strideY,this.constants.paddingY)),h=v(this.thread.x,this.constants.strideX,this.constants.paddingX),a=(m(this.thread.y,this.constants.strideY,this.constants.paddingY,this.constants.deltaHeight,this.constants.outputHeight),m(this.thread.x,this.constants.strideX,this.constants.paddingX,this.constants.deltaWidth,this.constants.outputWidth),t[this.thread.z][this.thread.y][this.thread.x]),d=0;d<this.constants.deltasHeight;d+=this.constants.strideY)for(var o=0;o<this.constants.deltasX;o+=this.constants.strideX)a+=i[this.thread.z][n+d][s+o]*e[this.thread.z][r+d][h+o];return a}function v(t,i,e){return Math.max(t*i-e,0)}function m(t,i,e,s,n){return Math.min(t*i-e+n,s)}function b(t,i,e){return Math.max(e-t*i,0)}function w(t,i,e,s,n){return Math.min(e-t*i+s,n)}function X(t,i){for(var e=0,s=0;s<=this.thread.y;s++){for(var n=this.thread.y-s,r=0;r<=this.thread.x;r++){for(var h=this.thread.x-r,a=0;a<this.constants.filterCount;a++)e+=t[a][n][h]*i[a][s][r];h--}n--}return e}function H(t,i){for(var e=0,s=0;s<this.constants.y;s++)for(var n=0;n<this.constants.x;n++)e+=i[this.thread.z][s][n];return t[this.thread.z]+e}var Y=function(n){function h(t,i){f(this,h);var s=c(this,(h.__proto__||Object.getPrototypeOf(h)).call(this,t));return s.stride=null,s.strideX=null,s.strideY=null,(0,e.setStride)(s,t),s.padding=null,s.paddingX=null,s.paddingY=null,(0,e.setPadding)(s,t),s.filterCount=t.filterCount,s.filterWidth=t.filterWidth,s.filterHeight=t.filterHeight,s.width=Math.floor((i.width+2*s.paddingX-s.filterWidth)/s.strideX+1),s.height=Math.floor((i.height+2*s.paddingY-s.filterHeight)/s.strideY+1),s.depth=s.filterCount,s.weights=(0,a.default)(s.width,s.height,s.depth),s.deltas=(0,o.default)(s.width,s.height,s.depth),s.biases=(0,l.default)(s.depth,s.bias),s.biasDeltas=(0,r.default)(s.depth),s.filters=(0,a.default)(s.filterWidth,s.filterHeight,s.filterCount),s.filterDeltas=(0,o.default)(s.filterWidth,s.filterHeight,s.filterCount),s.learnFilters=null,s.learnInputs=null,s.inputLayer=i,s.validate(),s}return g(h,s.Filter),t(h,null,[{key:"defaults",get:function(){return{stride:0,padding:0,bias:.1,filterCount:1,filterWidth:0,filterHeight:0}}}]),t(h,[{key:"setupKernels",value:function(){this.predictKernel=(0,i.makeKernel)(y,{constants:{inputWidth:this.inputLayer.width,inputHeight:this.inputLayer.height,inputDepth:this.inputLayer.depth,strideX:this.strideX,strideY:this.strideY,paddingX:this.paddingX,paddingY:this.paddingY,filterCount:this.filterCount,filterWidth:this.filterWidth,filterHeight:this.filterHeight},output:[this.width,this.height,this.depth]}),this.compareFiltersKernel=(0,i.makeKernel)(x,{constants:{deltasWidth:this.width,deltasHeight:this.height,deltasDepth:this.depth,inputWidth:this.inputLayer.width,inputHeight:this.inputLayer.height,inputDepth:this.inputLayer.depth,strideX:this.strideX,strideY:this.strideY,paddingX:this.paddingX,paddingY:this.paddingY,filterCount:this.filterCount,filterWidth:this.filterWidth,filterHeight:this.filterHeight},output:[this.width,this.height,this.depth]}),this.compareInputsKernel=(0,i.makeKernel)(X,{constants:{filterCount:this.filterCount},output:[this.inputLayer.width,this.inputLayer.height,this.inputLayer.depth]}),this.compareBiasesKernel=(0,i.makeKernel)(H,{output:[1,1,this.inputLayer.depth],constants:{x:1,y:1}})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights,this.filters,this.biases)}},{key:"compare",value:function(){this.filterDeltas=this.compareFiltersKernel(this.filterDeltas,this.inputLayer.weights,this.deltas),this.biasDeltas=this.compareBiasesKernel(this.biasDeltas,this.deltas),this.deltas=this.compareInputsKernel(this.filters,this.inputLayer.deltas),this.inputLayer.deltas=this.deltas}},{key:"learn",value:function(t,i,e){this.weights=this.praxis.run(this,t,i,e),this.deltas=(0,o.default)(this.width,this.height,this.depth)}}]),h}();exports.default=Y;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,r,i){return r&&t(e.prototype,r),i&&t(e,i),e}}();exports.trainingPredict=s,exports.predict=a;var e=require("./types"),r=require("../utilities/kernel");function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function n(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function o(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function s(t){return Math.random()<this.constants.probability?0:t[this.thread.y][this.thread.x]}function a(t){return t[this.thread.y][this.thread.x]*this.constants.probability}var u=function(u){function h(t,e){i(this,h);var r=n(this,(h.__proto__||Object.getPrototypeOf(h)).call(this,t));return r.inputLayer=e,r.validate(),r}return o(h,e.Filter),t(h,null,[{key:"defaults",get:function(){return{width:0,height:0,depth:0,probability:.5,isTraining:!1}}}]),t(h,[{key:"setupKernels",value:function(){this.isTraining?this.predictKernel=(0,r.makeKernel)(s,{output:[this.width,this.height,this.depth]}):this.predictKernel=(0,r.makeKernel)(a,{output:[this.width,this.height,this.depth]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}},{key:"compare",value:function(){this.deltas=this.learnKernel(this.deltas)}}]),h}();exports.default=u;
},{"./types":"pX1U","../utilities/kernel":"L30b"}],"Aqg2":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function t(e,i,r){null===e&&(e=Function.prototype);var s=Object.getOwnPropertyDescriptor(e,i);if(void 0===s){var h=Object.getPrototypeOf(e);return null===h?void 0:t(h,i,r)}if("value"in s)return s.value;var n=s.get;return void 0!==n?n.call(r):void 0},e=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}();exports.predict=m,exports.predict3D=b,exports.compareInputDeltas=D,exports.compareInputDeltas3D=K,exports.compareBiases=_,exports.compareFilterDeltas=O,exports.compareFilterDeltas3D=k;var i=require("./types"),r=require("../utilities/kernel"),s=require("../utilities/values"),h=y(s),n=require("../utilities/randos-2d"),a=y(n),o=require("../utilities/randos-3d"),u=y(o),l=require("../utilities/zeros"),p=y(l),d=require("../utilities/zeros-2d"),c=y(d),f=require("../utilities/zeros-3d"),g=y(f);function y(t){return t&&t.__esModule?t:{default:t}}function v(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function w(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function x(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function m(t,e,i){for(var r=0,s=0,h=0;h<this.constants.inputHeight;h++)for(var n=0;n<this.constants.inputWidth;n++)r+=t[h][n]*e[this.thread.x][s],s++;return r+i[this.thread.x]}function b(t,e,i){for(var r=0,s=0,h=0;h<this.constants.inputDepth;h++)for(var n=0;n<this.constants.inputHeight;n++)for(var a=0;a<this.constants.inputWidth;a++)r+=t[h][n][a]*e[this.thread.x][s],s++;return r+i[this.thread.x]}function D(t,e,i){for(var r=0,s=this.thread.x+this.thread.y*this.output.x,h=0;h<this.constants.filterCount;h++)r+=i[h][s]*e[0][h];return r+t[this.thread.y][this.thread.x]}function K(t,e,i){for(var r=0,s=this.thread.x+this.thread.y*this.output.x,h=0;h<this.constants.filterCount;h++)r+=i[h][s]*e[0][h];return r+t[this.thread.z][this.thread.y][this.thread.x]}function _(t,e){return t[this.thread.x]+e[this.thread.y][this.thread.x]}function O(t,e,i){var r=Math.floor(this.thread.x/this.constants.inputWidth),s=this.thread.x%this.constants.inputWidth;return t[this.thread.y][this.thread.x]+e[r][s]*i[0][this.thread.y]}function k(t,e,i){var r=Math.floor(this.thread.x/(this.constants.inputWidth*this.constants.inputHeight)),s=Math.floor((this.thread.x-r*this.constants.inputWidth*this.constants.inputHeight)/this.constants.inputWidth),h=this.thread.x-this.constants.inputWidth*(s+this.constants.inputHeight*r);return t[this.thread.y][this.thread.x]+e[r][s][h]*i[0][this.thread.y]}var W=function(s){function n(t,e){v(this,n);var i=w(this,(n.__proto__||Object.getPrototypeOf(n)).call(this,t));i.inputLayer=e,i.validate(),i.compareFilterDeltasKernel=null,i.compareInputDeltasKernel=null,i.compareBiasesKernel=null;var r=e.width*e.height*e.depth;return i.biases=(0,h.default)(i.height,i.bias),i.biasDeltas=(0,p.default)(i.height),i.filters=(0,a.default)(r,i.height),i.filterDeltas=(0,c.default)(r,i.height),i.depth>1?(i.weights=(0,u.default)(i.width,i.height),i.deltas=(0,g.default)(i.width,i.height)):i.height>1&&(i.weights=(0,a.default)(i.width,i.height),i.deltas=(0,c.default)(i.width,i.height)),i}return x(n,i.Filter),e(n,null,[{key:"defaults",get:function(){return{bias:.1}}}]),e(n,[{key:"validate",value:function(){if(t(n.prototype.__proto__||Object.getPrototypeOf(n.prototype),"validate",this).call(this),this.depth>1)throw new Error("depth not supported")}},{key:"setupKernels",value:function(){var t=this.inputLayer,e=t.width*t.height*t.depth;t.depth>1?(this.predictKernel=(0,r.makeKernel)(b,{output:[this.width,this.height],constants:{inputHeight:t.height,inputWidth:t.width,inputDepth:t.depth}}),this.compareFilterDeltasKernel=(0,r.makeKernel)(k,{output:[e,this.height],constants:{inputWidth:t.width,inputHeight:t.height}}),this.compareInputDeltasKernel=(0,r.makeKernel)(K,{output:[t.width,t.height,t.depth],constants:{filterCount:this.height}})):(this.predictKernel=(0,r.makeKernel)(m,{output:[this.width,this.height],constants:{inputHeight:t.height,inputWidth:t.width}}),this.compareFilterDeltasKernel=(0,r.makeKernel)(O,{output:[e,this.height],constants:{inputWidth:t.width}}),this.compareInputDeltasKernel=(0,r.makeKernel)(D,{output:[t.width,t.height],constants:{filterCount:this.height}})),this.compareBiasesKernel=(0,r.makeKernel)(_,{output:[this.width,this.height]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights,this.filters,this.biases)}},{key:"compare",value:function(){this.inputLayer.deltas=this.compareInputDeltasKernel(this.inputLayer.deltas,this.deltas,this.filters),this.biasDeltas=this.compareBiasesKernel(this.biases,this.deltas),this.filterDeltas=this.compareFilterDeltasKernel(this.filterDeltas,this.inputLayer.weights,this.deltas)}}]),n}();exports.default=W;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),t=require("./types"),r=require("../utilities/zeros-2d"),i=o(r),n=require("../utilities/kernel");function o(e){return e&&e.__esModule?e:{default:e}}function u(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function s(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var h=function(r){function o(e){u(this,o);var t=s(this,(o.__proto__||Object.getPrototypeOf(o)).call(this,e));return 1===t.width&&(t.predict=t.predict1D),t.validate(),t.weights=null,t.deltas=(0,i.default)(t.width,t.height),t}return l(o,t.Model),e(o,[{key:"setupKernels",value:function(){}},{key:"predict",value:function(e){if(e.length===this.height*this.width)this.weights=(0,n.kernelInput)(e,[this.width,this.height]);else{if(e.length!==this.height||e[0].length!==this.width)throw new Error("Inputs are not of sized correctly");this.weights=e}}},{key:"predict1D",value:function(e){for(var t=[],r=0;r<e.length;r++)t.push([e[r]]);this.weights=t}},{key:"compare",value:function(){}},{key:"learn",value:function(){this.deltas=(0,i.default)(this.width,this.height)}},{key:"toJSON",value:function(){for(var e={},t=this.constructor,r=t.defaults,i=t.name,n=Object.keys(r),o=0;o<n.length;o++){var u=n[o];"deltas"!==u&&"weights"!==u&&(e[u]=this[u])}return e.type=i,e}}]),o}();exports.default=h;
},{"./types":"pX1U","../utilities/zeros-2d":"C4Cz","../utilities/kernel":"L30b"}],"JZX2":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();exports.predict=u,exports.compare=s;var t=require("./types"),r=require("../utilities/kernel"),n=require("../activation/leaky-relu");function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function a(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function u(e){return(0,n.activate)(e[this.thread.y][this.thread.x])}function s(e,t){return(0,n.measure)(e[this.thread.y][this.thread.x],t[this.thread.y][this.thread.x])}var c=function(c){function h(e){i(this,h);var t=o(this,(h.__proto__||Object.getPrototypeOf(h)).call(this));t.inputLayer=e;var r=e.width,n=e.height,a=e.depth;return t.width=r,t.height=n,t.depth=a,t.validate(),t}return a(h,t.Activation),e(h,[{key:"setupKernels",value:function(){this.predictKernel=(0,r.makeKernel)(u,{functions:[n.activate]}),this.compareKernel=(0,r.makeKernel)(s,{functions:[n.measure]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}},{key:"compare",value:function(){this.deltas=this.compareKernel(this.weights,this.deltas)}}]),h}();exports.default=c;
},{"./types":"pX1U","../utilities/kernel":"L30b","../activation/leaky-relu":"4I3O"}],"xJEq":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,r,i){return r&&t(e.prototype,r),i&&t(e,i),e}}(),e=function t(e,r,i){null===e&&(e=Function.prototype);var n=Object.getOwnPropertyDescriptor(e,r);if(void 0===n){var o=Object.getPrototypeOf(e);return null===o?void 0:t(o,r,i)}if("value"in n)return n.value;var a=n.get;return void 0!==a?a.call(i):void 0};exports.predict=p,exports.compareFromX=l,exports.compareFromY=c;var r=require("../utilities/kernel"),i=require("../utilities/zeros-2d"),n=a(i),o=require("./types");function a(t){return t&&t.__esModule?t:{default:t}}function s(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function h(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function u(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function p(t,e){for(var r=0,i=0;i<this.constants.size;i++)r+=t[this.thread.y][i]*e[i][this.thread.x];return r}function l(t,e,r){for(var i=e[this.thread.y][this.thread.x],n=0;n<this.constants.size;n++)i+=t[this.thread.y][n]*r[this.thread.x][n];return i}function c(t,e,r){for(var i=e[this.thread.y][this.thread.x],n=0;n<this.constants.size;n++)i+=t[n][this.thread.x]*r[n][this.thread.y];return i}var y=function(i){function a(t,e){s(this,a);var r=h(this,(a.__proto__||Object.getPrototypeOf(a)).call(this));return r.inputLayer1=t,r.inputLayer2=e,r.compareKernel1=null,r.compareKernel2=null,r.width=e.width,r.height=t.height,r.validate(),r.weights=(0,n.default)(r.width,r.height),r.deltas=(0,n.default)(r.width,r.height),r}return u(a,o.Operator),t(a,[{key:"validate",value:function(){if(e(a.prototype.__proto__||Object.getPrototypeOf(a.prototype),"validate",this).call(this),this.inputLayer1.width!==this.inputLayer2.height)throw new Error("Layer width mismatch of "+this.inputLayer1.width+" and "+this.inputLayer2.height)}},{key:"setupKernels",value:function(){this.predictKernel=(0,r.makeKernel)(p,{output:[this.width,this.height],constants:{size:this.inputLayer2.height}}),this.compareKernel1=(0,r.makeKernel)(l,{output:[this.inputLayer1.width,this.inputLayer1.height],constants:{size:this.inputLayer2.width}}),this.compareKernel2=(0,r.makeKernel)(c,{output:[this.inputLayer2.width,this.inputLayer2.height],constants:{size:this.inputLayer1.height}})}},{key:"reuseKernels",value:function(t){e(a.prototype.__proto__||Object.getPrototypeOf(a.prototype),"reuseKernels",this).call(this,t),this.compareKernel1=t.compareKernel1,this.compareKernel2=t.compareKernel2}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer1.weights,this.inputLayer2.weights)}},{key:"compare",value:function(){var t=this.compareKernel1(this.deltas,this.inputLayer1.deltas,this.inputLayer2.weights),e=this.compareKernel2(this.deltas,this.inputLayer2.deltas,this.inputLayer1.weights);this.inputLayer2.deltas=e,this.inputLayer1.deltas=t}}]),a}();exports.default=y;
},{"../utilities/kernel":"L30b","../utilities/zeros-2d":"C4Cz","./types":"pX1U"}],"vjFV":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}(),e=function t(e,i,r){null===e&&(e=Function.prototype);var n=Object.getOwnPropertyDescriptor(e,i);if(void 0===n){var o=Object.getPrototypeOf(e);return null===o?void 0:t(o,i,r)}if("value"in n)return n.value;var h=n.get;return void 0!==h?h.call(r):void 0},i=require("../utilities/kernel"),r=require("./types"),n=require("../utilities/zeros-2d"),o=h(n);function h(t){return t&&t.__esModule?t:{default:t}}function a(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function u(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function l(t,e){return t[this.thread.y][this.thread.x]*e[this.thread.y][this.thread.x]}function p(t,e){return t[this.thread.y][this.thread.x]*e[this.thread.y][this.thread.x]}var c=function(n){function h(t,e){a(this,h);var i=u(this,(h.__proto__||Object.getPrototypeOf(h)).call(this));return i.inputLayer1=t,i.inputLayer2=e,i.width=t.width,i.height=t.height,i.validate(),i.weights=(0,o.default)(i.width,i.height),i.deltas=(0,o.default)(i.width,i.height),i}return s(h,r.Operator),t(h,[{key:"validate",value:function(){if(e(h.prototype.__proto__||Object.getPrototypeOf(h.prototype),"validate",this).call(this),this.inputLayer1.width!==this.inputLayer2.width)throw new Error("Layer width mismatch of "+this.inputLayer1.width+" and "+this.inputLayer2.width);if(this.inputLayer1.height!==this.inputLayer2.height)throw new Error("Layer height mismatch of "+this.inputLayer1.height+" and "+this.inputLayer2.height)}},{key:"setupKernels",value:function(){this.predictKernel=(0,i.makeKernel)(l,{output:[this.width,this.height]}),this.compareKernel=(0,i.makeKernel)(p,{output:[this.width,this.height]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.weights,this.inputLayer.weights)}},{key:"compare",value:function(){this.deltas=this.compareKernel(this.weights,this.deltas)}}]),h}();exports.default=c;
},{"../utilities/kernel":"L30b","./types":"pX1U","../utilities/zeros-2d":"C4Cz"}],"kuo+":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),t=require("../utilities/kernel"),r=require("./types");function n(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function o(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function u(e){return-e[this.thread.y][this.thread.x]}var a=function(a){function c(e,t){n(this,c);var r=i(this,(c.__proto__||Object.getPrototypeOf(c)).call(this,e));return r.inputLayer=t,r.validate(),r}return o(c,r.Modifier),e(c,[{key:"setupKernels",value:function(){this.predictKernel=(0,t.makeKernel)(u,{output:[this.width,this.height]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}}]),c}();exports.default=a;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../utilities/ones-2d"),t=i(e),r=require("../utilities/zeros-2d"),o=i(r),n=require("./types");function i(e){return e&&e.__esModule?e:{default:e}}function u(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function s(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function a(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var f=function(e){function r(e){u(this,r);var n=s(this,(r.__proto__||Object.getPrototypeOf(r)).call(this,e));return n.validate(),n.weights=(0,t.default)(n.width,n.height),n.deltas=(0,o.default)(n.width,n.height),n}return a(r,n.Model),r}();exports.default=f;
},{"../utilities/ones-2d":"jZTY","../utilities/zeros-2d":"C4Cz","./types":"pX1U"}],"vNYh":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},e=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}();exports.predict=g,exports.compare=y,exports.compare3D=w;var i=require("./types"),n=require("../utilities/kernel"),r=require("../utilities/layer-setup"),s=require("../utilities/zeros-3d"),h=a(s),o=require("../utilities/randos-3d"),u=a(o);function a(t){return t&&t.__esModule?t:{default:t}}function l(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function d(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function p(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function f(t){return t}function c(t){return t}function g(t){for(var e=Math.floor(this.thread.x/this.output.x*this.constants.inputWidth-this.constants.paddingX),i=Math.floor(this.thread.y/this.output.y*this.constants.inputHeight-this.constants.paddingY),n=-1/0,r=-1,s=-1,h=0;h<this.constants.filterHeight;h++)for(var o=h+i,u=0;u<this.constants.filterWidth;u++){var a=u+e;if(o>=0&&o<this.constants.inputHeight&&a>=0&&a<this.constants.inputWidth){var l=t[this.thread.z][o][a];l>n&&(n=l,s=o,r=a)}}return f(s),c(r),n}function y(t,e,i){for(var n=Math.floor(this.thread.x/this.output.x*this.constants.outputWidth),r=Math.floor(this.thread.y/this.output.y*this.constants.outputHeight),s=0,h=0;h<this.constants.inputHeight;h++)for(var o=0;o<this.constants.inputWidth;o++){var u=i[h][o],a=e[h][o];u===n&&a===r&&(s+=t[h][o])}return s}function w(t,e,i){for(var n=Math.floor(this.thread.x/this.output.x*this.constants.outputWidth),r=Math.floor(this.thread.y/this.output.y*this.constants.outputHeight),s=0,h=0;h<this.constants.inputHeight;h++)for(var o=0;o<this.constants.inputWidth;o++){var u=i[this.thread.z][h][o],a=e[this.thread.z][h][o];u===n&&a===r&&(s+=t[this.thread.z][h][o])}return s}var b=function(s){function o(t,e){l(this,o);var i=d(this,(o.__proto__||Object.getPrototypeOf(o)).call(this,t));return i.stride=null,i.strideX=null,i.strideY=null,(0,r.setStride)(i,t),i.padding=null,i.paddingX=null,i.paddingY=null,(0,r.setPadding)(i,t),i.filterCount=t.filterCount,i.filterWidth=t.filterWidth,i.filterHeight=t.filterHeight,i.width=Math.floor((e.width+2*i.paddingX-i.filterWidth)/i.strideX+1),i.height=Math.floor((e.height+2*i.paddingY-i.filterHeight)/i.strideY+1),i.depth=i.filterCount,i.weights=(0,u.default)(i.width,i.height,i.depth),i.deltas=(0,h.default)(i.width,i.height,i.depth),i.filters=(0,u.default)(i.filterWidth,i.filterHeight,i.filterCount),i.filterDeltas=(0,h.default)(i.filterWidth,i.filterHeight,i.filterCount),i.learnFilters=null,i.learnInputs=null,i.inputLayer=e,i.validate(),i}return p(o,i.Filter),e(o,null,[{key:"defaults",get:function(){return{padding:0,bias:0,filterWidth:0,filterHeight:0,filterCount:0}}}]),e(o,[{key:"setupKernels",value:function(){this.predictKernel=(0,n.makeKernel)(g,{output:[this.width,this.height,this.depth],map:{switchX:c,switchY:f},constants:{inputWidth:this.inputLayer.width,inputHeight:this.inputLayer.height,paddingX:this.paddingX,paddingY:this.paddingY,filterHeight:this.filterHeight,filterWidth:this.filterWidth}}),this.compareKernel=(0,n.makeKernel)(y,{output:[this.inputLayer.width,this.inputLayer.height,this.inputLayer.depth],constants:{outputWidth:this.width,outputHeight:this.height,outputDepth:this.depth,paddingX:this.paddingX,paddingY:this.paddingY}})}},{key:"predict",value:function(){var t=this.predictKernel(this.inputLayer.weights);return this.switchX=t.switchX,this.switchY=t.switchY,this.weights=t.result,this.weights}},{key:"compare",value:function(){this.inputLayer.deltas.length,this.inputLayer.deltas[0].length,this.inputLayer.deltas[0][0].length,t(this.inputLayer.deltas[0][0][0]);this.inputLayer.deltas=this.compareKernel(this.deltas,this.switchX,this.switchY),this.inputLayer.deltas.length,this.inputLayer.deltas[0].length,this.inputLayer.deltas[0][0].length,t(this.inputLayer.deltas[0][0][0])}}]),o}();exports.default=b;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),t=require("./types"),r=require("../utilities/randos-2d"),n=u(r),o=require("../utilities/zeros-2d"),i=u(o);function u(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function c(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function f(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var l=function(r){function o(e){a(this,o);var t=c(this,(o.__proto__||Object.getPrototypeOf(o)).call(this,e));return t.validate(),t.weights=(0,n.default)(t.width,t.height),t.deltas=(0,i.default)(t.width,t.height),t}return f(o,t.Model),e(o,[{key:"predict",value:function(){}},{key:"compare",value:function(){}}]),o}();exports.default=l;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}();exports.predict=p,exports.compare=d,exports.predict3D=f,exports.compare3D=y;var t=require("./types"),r=require("../utilities/kernel"),i=require("../activation/relu"),n=require("../utilities/zeros-2d"),a=s(n),u=require("../utilities/zeros-3d"),o=s(u);function s(e){return e&&e.__esModule?e:{default:e}}function h(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function c(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function p(e){return(0,i.activate)(e[this.thread.y][this.thread.x])}function d(e,t){return(0,i.measure)(e[this.thread.y][this.thread.x],t[this.thread.y][this.thread.x])}function f(e){return(0,i.activate)(e[this.thread.z][this.thread.y][this.thread.x])}function y(e,t){return(0,i.measure)(e[this.thread.z][this.thread.y][this.thread.x],t[this.thread.z][this.thread.y][this.thread.x])}var v=function(n){function u(e){h(this,u);var t=c(this,(u.__proto__||Object.getPrototypeOf(u)).call(this));t.inputLayer=e;var r=e.width,i=e.height,n=e.depth;return t.width=r,t.height=i,t.validate(),n>1?(t.depth=n,t.weights=(0,o.default)(r,i,n),t.deltas=(0,o.default)(r,i,n)):(t.depth=1,t.weights=(0,a.default)(r,i),t.deltas=(0,a.default)(r,i)),t}return l(u,t.Activation),e(u,[{key:"setupKernels",value:function(){var e=this.inputLayer,t=e.width,n=e.height,a=e.depth;this.depth>1?(this.predictKernel=(0,r.makeKernel)(f,{output:[t,n,a],functions:[i.activate]}),this.compareKernel=(0,r.makeKernel)(y,{output:[t,n,a],functions:[i.measure]})):(this.predictKernel=(0,r.makeKernel)(p,{output:[t,n],functions:[i.activate]}),this.compareKernel=(0,r.makeKernel)(d,{output:[t,n],functions:[i.measure]}))}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}},{key:"compare",value:function(){this.inputLayer.deltas=this.compareKernel(this.weights,this.deltas)}}]),u}();exports.default=v;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}();exports.predict=c,exports.compare=l;var t=require("./types"),r=require("../utilities/kernel"),i=require("../activation/sigmoid"),n=require("../utilities/zeros-2d"),o=a(n);function a(e){return e&&e.__esModule?e:{default:e}}function u(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function s(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function h(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function c(e){return(0,i.activate)(e[this.thread.y][this.thread.x])}function l(e,t){var r=e[this.thread.y][this.thread.x],n=t[this.thread.y][this.thread.x];return(0,i.measure)(r,n)}var f=function(n){function a(e){u(this,a);var t=s(this,(a.__proto__||Object.getPrototypeOf(a)).call(this));t.inputLayer=e;var r=e.width,i=e.height;return t.width=r,t.height=i,t.validate(),t.weights=(0,o.default)(t.width,t.height),t.deltas=(0,o.default)(t.width,t.height),t}return h(a,t.Activation),e(a,[{key:"setupKernels",value:function(){this.predictKernel=(0,r.makeKernel)(c,{output:[this.width,this.height],functions:[i.activate]}),this.compareKernel=(0,r.makeKernel)(l,{output:[this.width,this.height],functions:[i.measure]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}},{key:"compare",value:function(){this.inputLayer.deltas=this.compareKernel(this.weights,this.deltas)}}]),a}();exports.default=f;
},{"./types":"pX1U","../utilities/kernel":"L30b","../activation/sigmoid":"thFH","../utilities/zeros-2d":"C4Cz"}],"nfIB":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,r,i){return r&&t(e.prototype,r),i&&t(e,i),e}}();exports.getMaxValue=K,exports.getMaxValue2D=m,exports.getMaxValue3D=w,exports.getSum=b,exports.getSum2D=k,exports.getSum3D=D,exports.getExponentials=M,exports.getExponentials2D=_,exports.getExponentials3D=E,exports.predict=W,exports.predict2D=O,exports.predict3D=q,exports.compare=H,exports.compare2D=S,exports.compare3D=j,exports.loss=z;var e=require("../utilities/kernel"),r=require("./types"),i=require("../utilities/randos"),n=x(i),s=require("../utilities/randos-2d"),u=x(s),h=require("../utilities/randos-3d"),a=x(h),o=require("../utilities/zeros"),p=x(o),l=require("../utilities/zeros-2d"),d=x(l),c=require("../utilities/zeros-3d"),f=x(c);function x(t){return t&&t.__esModule?t:{default:t}}function g(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function v(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function y(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function K(t){for(var e=-1/0,r=0;r<this.constants.inputWidth;r++){var i=t[r];i>e&&(e=i)}return e}function m(t){for(var e=-1/0,r=0;r<this.constants.inputHeight;r++)for(var i=0;i<this.constants.inputWidth;i++){var n=t[r][i];n>e&&(e=n)}return e}function w(t){for(var e=-1/0,r=0;r<this.constants.inputDepth;r++)for(var i=0;i<this.constants.inputHeight;i++)for(var n=0;n<this.constants.inputWidth;n++){var s=t[r][i][n];s>e&&(e=s)}return e}function b(t){for(var e=0,r=0;r<this.constants.inputWidth;r++)e+=t[r];return e}function k(t){for(var e=0,r=0;r<this.constants.inputHeight;r++)for(var i=0;i<this.constants.inputWidth;i++)e+=t[r][i];return e}function D(t){for(var e=0,r=0;r<this.constants.inputDepth;r++)for(var i=0;i<this.constants.inputHeight;i++)for(var n=0;n<this.constants.inputWidth;n++)e+=t[r][i][n];return e}function M(t,e){return Math.exp(t[this.thread.x]-e[0])}function _(t,e){return Math.exp(t[this.thread.y][this.thread.x]-e[0])}function E(t,e){return Math.exp(t[this.thread.z][this.thread.y][this.thread.x]-e[0])}function W(t,e){return t[this.thread.x]/e[0]}function O(t,e){return t[this.thread.y][this.thread.x]/e[0]}function q(t,e){return t[this.thread.z][this.thread.y][this.thread.x]/e[0]}function H(t,e){var r=0;return this.thread.x===t&&(r=1),-(r-e[this.thread.x])}function S(t,e){var r=0;return this.thread.x+this.thread.y*this.output.x===t&&(r=1),-(r-e[this.thread.y][this.thread.x])}function j(t,e){var r=0;return this.thread.x+this.thread.y*this.output.x+this.thread.z*this.output.x*this.output.y===t&&(r=1),-(r-e[this.thread.z][this.thread.y][this.thread.x])}function z(t){return-Math.log()}var V=function(i){function s(t){g(this,s);var e=v(this,(s.__proto__||Object.getPrototypeOf(s)).call(this));return e.width=t.width,e.height=t.height,e.depth=t.depth,e.getExponentialsKernel=null,e.getMaxValueKernel=null,e.getSumKernel=null,e.inputLayer=t,e.validate(),e.height>1?e.depth>1?(e.weights=(0,a.default)(e.width,e.height,e.depth),e.deltas=(0,f.default)(e.width,e.height,e.depth)):(e.weights=(0,u.default)(e.width,e.height),e.deltas=(0,d.default)(e.width,e.height)):(e.weights=(0,n.default)(e.width),e.deltas=(0,p.default)(e.width)),e}return y(s,r.Filter),t(s,[{key:"setupKernels",value:function(){var t=this.width,r=this.height,i=this.depth;i>1?(this.getExponentialsKernel=(0,e.makeKernel)(E,{output:[t,r,i]}),this.getMaxValueKernel=(0,e.makeKernel)(w,{output:[1,1,1],constants:{inputWidth:t,inputHeight:r,inputDepth:i}}),this.getSumKernel=(0,e.makeKernel)(D,{output:[1,1,1],constants:{inputWidth:t,inputHeight:r,inputDepth:i}}),this.predictKernel=(0,e.makeKernel)(q,{output:[t,r,i]}),this.compareKernel=(0,e.makeKernel)(j,{output:[t,r,i]})):(this.getExponentialsKernel=(0,e.makeKernel)(M,{output:[t,r]}),this.getMaxValueKernel=(0,e.makeKernel)(m,{output:[1,1],constants:{inputWidth:t,inputHeight:r}}),this.getSumKernel=(0,e.makeKernel)(k,{output:[1,1],constants:{inputWidth:t,inputHeight:r}}),this.predictKernel=(0,e.makeKernel)(O,{output:[t,r]}),this.compareKernel=(0,e.makeKernel)(S,{output:[t,r]}))}},{key:"predict",value:function(){var t=this.getMaxValueKernel(this.inputLayer.weights),e=this.getExponentialsKernel(this.inputLayer.weights,t),r=this.getSumKernel(e);this.weights=this.predictKernel(e,r)}},{key:"compare",value:function(t){this.errors=this.compareKernel(t[0],this.deltas),this.deltas=this.errors,this.inputLayer.deltas=this.deltas}}]),s}();exports.default=V;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}();exports.predict=c,exports.compare=l;var t=require("./types"),r=require("../utilities/kernel"),i=require("../activation/tanh"),n=require("../utilities/zeros-2d"),o=a(n);function a(e){return e&&e.__esModule?e:{default:e}}function h(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function s(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function c(e){return Math.tanh(e[this.thread.y][this.thread.x])}function l(e,t){return(0,i.tanhDerivative)(e[this.thread.y][this.thread.x],t[this.thread.y][this.thread.x])}var p=function(n){function a(e){h(this,a);var t=u(this,(a.__proto__||Object.getPrototypeOf(a)).call(this));t.inputLayer=e;var r=t.inputLayer,i=r.width,n=r.height,s=r.depth;return t.width=i,t.height=n,t.depth=s,t.validate(),t.weights=(0,o.default)(t.width,t.height),t.deltas=(0,o.default)(t.width,t.height),t}return s(a,t.Activation),e(a,[{key:"setupKernels",value:function(){this.predictKernel=(0,r.makeKernel)(c,{output:[this.width,this.height]}),this.compareKernel=(0,r.makeKernel)(l,{output:[this.width,this.height],functions:[i.tanhDerivative]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}},{key:"compare",value:function(){this.deltas=this.compareKernel(this.weights,this.deltas)}}]),a}();exports.default=p;
},{"./types":"pX1U","../utilities/kernel":"L30b","../activation/tanh":"v3/M","../utilities/zeros-2d":"C4Cz"}],"xXoy":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),t=require("../utilities/kernel"),r=require("../utilities/zeros"),i=a(r),h=require("../utilities/zeros-2d"),n=a(h),o=require("../utilities/zeros-3d"),u=a(o),s=require("./types");function a(e){return e&&e.__esModule?e:{default:e}}function l(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function d(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function f(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function c(e,t){return e[this.thread.y][this.thread.x]-t[this.thread.x]}function p(e,t){return e[this.thread.y][this.thread.x]-t[this.thread.y][this.thread.x]}var w=function(r){function h(e,t){l(this,h);var r=d(this,(h.__proto__||Object.getPrototypeOf(h)).call(this,e));return r.inputLayer=t,r.width=t.width,r.height=t.height,r.depth=t.depth,r.validate(),r.depth>1?(r.weights=(0,u.default)(r.width,r.height,r.depth),r.deltas=(0,u.default)(r.width,r.height,r.depth),r.errors=(0,u.default)(r.width,r.height,r.depth)):r.height>1?(r.weights=(0,n.default)(r.width,r.height),r.deltas=(0,n.default)(r.width,r.height),r.errors=(0,n.default)(r.width,r.height)):(r.weights=(0,i.default)(r.width),r.deltas=(0,i.default)(r.width),r.errors=(0,i.default)(r.width)),r}return f(h,s.Filter),e(h,[{key:"setupKernels",value:function(){var e=1===this.width?c:p;this.compareKernel=(0,t.makeKernel)(e,{output:[this.width,this.height]})}},{key:"predict",value:function(){this.weights=this.inputLayer.weights}},{key:"compare",value:function(e){this.errors=this.compareKernel(this.weights,e),this.deltas=this.errors,this.inputLayer.deltas=this.deltas}}]),h}();exports.default=w;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),t=require("./types"),r=require("../utilities/kernel");function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function n(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function o(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function u(e){return e[this.thread.x][this.thread.y]}var a=function(a){function s(e){i(this,s);var t=n(this,(s.__proto__||Object.getPrototypeOf(s)).call(this));return t.inputLayer=e,t.width=t.inputLayer.height,t.height=t.inputLayer.width,t.validate(),t}return o(s,t.Modifier),e(s,[{key:"setupKernels",value:function(){this.predictKernel=(0,r.makeKernel)(u,{output:[this.height,this.width]}),this.compareKernel=(0,r.makeKernel)(u,{output:[this.width,this.height]})}},{key:"predict",value:function(){this.weights=this.predictKernel(this.inputLayer.weights)}},{key:"compare",value:function(){this.inputLayer.deltas=this.predictKernel(this.deltas)}}]),s}();exports.default=a;
},{"./types":"pX1U","../utilities/kernel":"L30b"}],"EO/P":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),t=require("../utilities/zeros-2d"),r=o(t),n=require("./types");function o(e){return e&&e.__esModule?e:{default:e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function a(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var c=function(t){function o(e){i(this,o);var t=u(this,(o.__proto__||Object.getPrototypeOf(o)).call(this,e));return t.validate(),t.weights=(0,r.default)(t.width,t.height),t.deltas=(0,r.default)(t.width,t.height),t}return a(o,n.Model),e(o,[{key:"predict",value:function(){}},{key:"compare",value:function(){}}]),o}();exports.default=c;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,r,i){return r&&t(e.prototype,r),i&&t(e,i),e}}(),e=require("stream"),r=require("./lookup"),i=o(r);function o(t){return t&&t.__esModule?t:{default:t}}function n(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function a(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function u(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}function l(t){return[].concat(u(new Set(t)))}var h=function(r){function o(t){n(this,o);var e=a(this,(o.__proto__||Object.getPrototypeOf(o)).call(this,{objectMode:!0}));if(!(t=t||{}).neuralNetwork)throw new Error("no neural network specified");return e.neuralNetwork=t.neuralNetwork,e.dataFormatDetermined=!1,e.inputKeys=[],e.outputKeys=[],e.i=0,e.iterations=t.iterations||2e4,e.errorThresh=t.errorThresh||.005,e.log=!!t.log&&("function"==typeof t.log?t.log:console.log),e.logPeriod=t.logPeriod||10,e.callback=t.callback,e.callbackPeriod=t.callbackPeriod||10,e.floodCallback=t.floodCallback,e.doneTrainingCallback=t.doneTrainingCallback,e.size=0,e.count=0,e.sum=0,e.on("finish",e.finishStreamIteration.bind(e)),a(e,e)}return s(o,e.Writable),t(o,[{key:"_write",value:function(t,e,r){if(!t)return this.emit("finish"),r();if(!this.dataFormatDetermined)return this.size++,this.inputKeys=l(this.inputKeys.slice(0).concat(Object.keys(t.input))),this.outputKeys=l(this.outputKeys.slice(0).concat(Object.keys(t.output))),this.firstDatum=this.firstDatum||t,r();this.count++;var i=this.neuralNetwork.formatData(t);return this.trainDatum(i[0]),r()}},{key:"trainDatum",value:function(t){var e=this.neuralNetwork.trainPattern(t.input,t.output);this.sum+=e}},{key:"finishStreamIteration",value:function(){if(this.dataFormatDetermined&&this.size!==this.count&&this.log("This iteration's data length was different from the first."),!this.dataFormatDetermined){this.neuralNetwork.inputLookup=i.default.lookupFromArray(this.inputKeys),Array.isArray(this.firstDatum.output)||(this.neuralNetwork.outputLookup=i.default.lookupFromArray(this.outputKeys));var t=this.neuralNetwork.formatData(this.firstDatum),e=[],r=t[0].input.length,o=t[0].output.length,n=this.hiddenSizes;return n?n.forEach(function(t){e.push(t)}):e.push(Math.max(3,Math.floor(r/2))),e.unshift(r),e.push(o),this.dataFormatDetermined=!0,this.neuralNetwork.initialize(e),void("function"==typeof this.floodCallback&&this.floodCallback())}var a=this.sum/this.size;if(this.log&&this.i%this.logPeriod==0&&this.log("iterations:",this.i,"training error:",a),this.callback&&this.i%this.callbackPeriod==0&&this.callback({error:a,iterations:this.i}),this.sum=0,this.count=0,this.i++,this.i<this.iterations&&a>this.errorThresh){if("function"==typeof this.floodCallback)return this.floodCallback()}else if("function"==typeof this.doneTrainingCallback)return this.doneTrainingCallback({error:a,iterations:this.i})}}]),o}();exports.default=h;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}return function(e,i,s){return i&&t(e.prototype,i),s&&t(e,s),e}}(),e=function t(e,i,s){null===e&&(e=Function.prototype);var a=Object.getOwnPropertyDescriptor(e,i);if(void 0===a){var r=Object.getPrototypeOf(e);return null===r?void 0:t(r,i,s)}if("value"in a)return a.value;var n=a.get;return void 0!==n?n.call(s):void 0},i=require("gpu.js"),s=o(i),a=require("./neural-network"),r=o(a),n=require("./lookup"),u=o(n);function o(t){return t&&t.__esModule?t:{default:t}}function h(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function c(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function p(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function l(t,e,i){for(var s=e[this.thread.x],a=0;a<this.constants.size;a++)s+=t[this.thread.x][a]*i[a];return 1/(1+Math.exp(-s))}function d(t,e,i){for(var s=e[this.thread.x],a=0;a<this.constants.size;a++)s+=t[this.thread.x][a]*i[a];return s<0?0:s}function f(t,e,i){for(var s=e[this.thread.x],a=0;a<this.constants.size;a++)s+=t[this.thread.x][a]*i[a];return s<0?0:.01*s}function g(t,e,i){for(var s=e[this.thread.x],a=0;a<this.constants.size;a++)s+=t[this.thread.x][a]*i[a];return Math.tanh(s)}function v(t,e){return e[this.thread.x]-t}function y(t,e){return t*e*(1-e)}function b(t,e){return e>0?t:0}function w(t,e){return e>0?t:.01*t}function z(t,e){return(1-e*e)*t}function k(t,e){for(var i=0,s=0;s<this.constants.size;s++)i+=e[s]*t[s][this.thread.x];return i}function x(t,e,i){return this.constants.learningRate*e[this.thread.y]*i[this.thread.x]+this.constants.momentum*t[this.thread.y][this.thread.x]}function C(t,e){return t+e[this.thread.y][this.thread.x]}function m(t,e){return t[this.thread.x]+e[this.thread.x]*this.constants.learningRate}function _(t){for(var e=0,i=0;i<this.constants.size;i++)e+=Math.pow(t[i],2);return e/this.constants.size}var P=function(i){function a(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};h(this,a);var e=c(this,(a.__proto__||Object.getPrototypeOf(a)).call(this,t));return e.forwardPropagate=[],e.backwardPropagate=[],e.changesPropagate=[],e.biasesPropagate=[],e.biasCopies=[],e.copyBias=[],e.changesCopies=[],e.copyChanges=[],e.weightsCopies=[],e.copyWeights=[],e.errorCheckInterval=100,e.gpu=new s.default({mode:t.mode}),e}return p(a,r.default),t(a,[{key:"_initialize",value:function(){e(a.prototype.__proto__||Object.getPrototypeOf(a.prototype),"_initialize",this).call(this),this.buildRunInput(),this.buildCalculateDeltas(),this.buildGetChanges(),this.buildChangeBiases(),this.buildGetMSE()}},{key:"setActivation",value:function(){throw new Error(this.constructor.name+"-setActivation is not yet implemented")}},{key:"_trainPattern",value:function(t,e,i){return this.runInput(t),this.calculateDeltas(e),this.getChanges(),this.changeBiases(),i?this.getMSE(this.errors[this.outputLayer])[0]:null}},{key:"buildRunInput",value:function(){var t=this,e=null;switch(this.activation){case"sigmoid":e=l;break;case"relu":e=d;break;case"leaky-relu":e=f;break;case"tanh":e=g;break;default:throw new Error("unknown activation "+this.activation)}for(var i=1;i<=this.outputLayer;i++)this.forwardPropagate[i]=this.gpu.createKernel(e,{output:[this.sizes[i]],outputToTexture:!0,hardcodeConstants:!0,constants:{size:this.sizes[i-1]}});this._texturizeInputData=this.gpu.createKernel(function(e){return e[t.thread.x]},{output:[this.sizes[1]],outputToTexture:!0,hardcodeConstants:!0,outputImmutable:!0})}},{key:"runInput",value:function(t){var e=void 0;this.outputs[0]=t;for(var i=1;i<=this.outputLayer;i++)this.outputs[i]=this.forwardPropagate[i](this.weights[i],this.biases[i],t),e=t=this.outputs[i];return e}},{key:"buildCalculateDeltas",value:function(){var t=this,e=null;switch(this.activation){case"sigmoid":e=y;break;case"relu":e=b;break;case"leaky-relu":e=w;break;case"tanh":e=z;break;default:throw new Error("unknown activation "+this.activation)}for(var i=this.outputLayer;i>0;i--)i===this.outputLayer?this.backwardPropagate[i]=this.gpu.createKernelMap({error:s.default.alias("calcErrorOutput",v),deltas:s.default.alias("calcDeltas",e)},function(i,s){var a=i[t.thread.x];return e(v(a,s),a)},{output:[this.sizes[i]],outputToTexture:!0,hardcodeConstants:!0}):this.backwardPropagate[i]=this.gpu.createKernelMap({error:s.default.alias("calcError",k),deltas:s.default.alias("calcDeltas",e)},function(i,s,a){var r=s[t.thread.x];return e(k(i,a),r)},{output:[this.sizes[i]],outputToTexture:!0,hardcodeConstants:!0,constants:{size:this.deltas[i+1].length}})}},{key:"calculateDeltas",value:function(t){for(var e=this.outputLayer;e>0;e--){var i=void 0;i=e===this.outputLayer?this.backwardPropagate[e](this.outputs[e],t):this.backwardPropagate[e](this.weights[e+1],this.outputs[e],this.deltas[e+1]),this.deltas[e]=i.deltas,this.errors[e]=i.error}}},{key:"buildGetChanges",value:function(){for(var t=this,e=1;e<=this.outputLayer;e++)this.changesPropagate[e]=this.gpu.createKernelMap({weights:s.default.alias("addWeights",C),changes:s.default.alias("calcChanges",x)},function(t,e,i,s){return C(x(s,e,t),i)},{output:[this.sizes[e-1],this.sizes[e]],outputToTexture:!0,hardcodeConstants:!0,constants:{size:this.outputs[e-1].length,learningRate:this.trainOpts.learningRate,momentum:this.trainOpts.momentum}}),this.copyChanges[e]=this.gpu.createKernel(function(e){return e[t.thread.y][t.thread.x]},{output:this.changesPropagate[e].output,outputToTexture:!0,hardCodeConstants:!0}),this.copyWeights[e]=this.gpu.createKernel(function(e){return e[t.thread.y][t.thread.x]},{output:this.changesPropagate[e].output,outputToTexture:!0,hardCodeConstants:!0})}},{key:"getChanges",value:function(){for(var t=1;t<=this.outputLayer;t++){var e=this.changesPropagate[t](this.outputs[t-1],this.deltas[t],this.weightsCopies[t]||this.weights[t],this.changesCopies[t]||this.changes[t]);this.changes[t]=e.changes,this.weights[t]=e.weights,this.changesCopies[t]=this.copyChanges[t](e.changes),this.weightsCopies[t]=this.copyWeights[t](e.weights)}}},{key:"buildChangeBiases",value:function(){for(var t=this,e=1;e<=this.outputLayer;e++)this.biasesPropagate[e]=this.gpu.createKernel(m,{output:[this.sizes[e]],outputToTexture:!0,hardcodeConstants:!0,constants:{learningRate:this.trainOpts.learningRate}}),this.copyBias[e]=this.gpu.createKernel(function(e){return e[t.thread.x]},{output:this.biasesPropagate[e].output,outputToTexture:!0,hardCodeConstants:!0})}},{key:"changeBiases",value:function(){for(var t=1;t<=this.outputLayer;t++)this.biases[t]=this.biasesPropagate[t](this.biasCopies[t]||this.biases[t],this.deltas[t]),this.biasCopies[t]=this.copyBias[t](this.biases[t])}},{key:"buildGetMSE",value:function(){this.getMSE=this.gpu.createKernel(_,{output:[1],hardcodeConstants:!0,constants:{size:this.sizes[this.outputLayer]}})}},{key:"run",value:function(t){if(!this.isRunnable)return null;this.inputLookup&&(t=u.default.toArray(this.inputLookup,t));var e=this._texturizeInputData(t),i=this.runInput(e).toArray(this.gpu);return this.outputLookup&&(i=u.default.toHash(this.outputLookup,i)),i}},{key:"_verifyIsInitialized",value:function(t){var e=this;this.sizes||(this.sizes=[],t[0].size||(t[0].size={input:t[0].input.length,output:t[0].output.length}),this.sizes.push(t[0].size.input),this.hiddenSizes?this.hiddenSizes.forEach(function(t){e.sizes.push(t)}):this.sizes.push(Math.max(3,Math.floor(t[0].size.input/2))),this.sizes.push(t[0].size.output),this._initialize())}},{key:"_prepTraining",value:function(t,e){var i=this;this._updateTrainingOptions(e),t=this._formatData(t);var s=Date.now()+this.trainOpts.timeout;this._verifyIsInitialized(t);var a=this.gpu.createKernel(function(t){return t[i.thread.x]},{output:[t[0].output.length],outputToTexture:!0,hardcodeConstants:!0,outputImmutable:!0});return{data:t.map(function(t){return{size:t.size,input:i._texturizeInputData(t.input),output:a(t.output)}}),status:{error:1,iterations:0},endTime:s}}},{key:"toFunction",value:function(){throw new Error(this.constructor.name+"-toFunction is not yet implemented")}}]),a}();exports.default=P;
},{"gpu.js":"dc+G","./neural-network":"8epZ","./lookup":"Q1a6"}],"sLgS":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),t=require("./types"),n=require("../utilities/zeros-2d"),r=i(n);function i(e){return e&&e.__esModule?e:{default:e}}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function s(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var a=function(n){function i(){return o(this,i),u(this,(i.__proto__||Object.getPrototypeOf(i)).apply(this,arguments))}return s(i,t.Internal),e(i,[{key:"setLayer",value:function(e){this.layer=e}},{key:"predict",value:function(){}},{key:"compare",value:function(){}},{key:"learn",value:function(){this.layer.deltas=(0,r.default)(this.width,this.height)}},{key:"setupKernels",value:function(){}},{key:"reuseKernels",value:function(){}},{key:"width",get:function(){return this.layer.width},set:function(e){throw new Error(this.constructor.name+"-width is not yet implemented")}},{key:"height",get:function(){return this.layer.height},set:function(e){throw new Error(this.constructor.name+"-height is not yet implemented")}},{key:"deltas",get:function(){return this.layer.deltas},set:function(e){this.layer.deltas=e}},{key:"weights",get:function(){return this.layer.weights},set:function(e){this.layer.weights=e}}]),i}();exports.default=a;
},{"./types":"pX1U","../utilities/zeros-2d":"C4Cz"}],"kvWK":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),e=require("./types"),r=require("./base"),n=i(r);function i(t){return t&&t.__esModule?t:{default:t}}function u(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function o(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var c=function(r){function i(){return u(this,i),o(this,(i.__proto__||Object.getPrototypeOf(i)).apply(this,arguments))}return s(i,e.Internal),t(i,[{key:"setRecurrentInput",value:function(t){this.recurrentInput=t,this.validate()}},{key:"validate",value:function(){if(n.default.prototype.validate.call(this),this.width!==this.recurrentInput.width)throw new Error(this.constructor.name+" layer width "+this.width+" and "+this.recurrentInput.constructor.name+" width ("+this.recurrentInput.width+") are not same");if(this.height!==this.recurrentInput.height)throw new Error(this.constructor.name+" layer height "+this.height+" and "+this.recurrentInput.constructor.name+" width ("+this.recurrentInput.height+") are not same")}},{key:"setDimensions",value:function(t,e){this.width=t,this.height=e}},{key:"predict",value:function(){}},{key:"compare",value:function(){}},{key:"learn",value:function(){}},{key:"setupKernels",value:function(){}},{key:"reuseKernels",value:function(){}},{key:"deltas",get:function(){return this.recurrentInput.deltas},set:function(t){this.recurrentInput.deltas=t}},{key:"weights",get:function(){return this.recurrentInput.weights},set:function(t){this.recurrentInput.weights=t}}]),i}();exports.default=c;
},{"./types":"pX1U","./base":"kIeX"}],"7ZE4":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),t=require("../utilities/zeros-2d"),n=i(t),r=require("./types");function i(e){return e&&e.__esModule?e:{default:e}}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function s(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var a=function(t){function i(){return o(this,i),u(this,(i.__proto__||Object.getPrototypeOf(i)).apply(this,arguments))}return s(i,r.Internal),e(i,[{key:"setDimensions",value:function(e,t){this.praxis=null,this.width=e,this.height=t,this.weights=(0,n.default)(e,t),this.deltas=(0,n.default)(e,t)}},{key:"setupKernels",value:function(){}},{key:"reuseKernels",value:function(){}},{key:"predict",value:function(){}},{key:"compare",value:function(){}},{key:"learn",value:function(e,t,r){this.weights=this.praxis.run(this,e,t,r),this.deltas=(0,n.default)(this.width,this.height)}},{key:"validate",value:function(){throw new Error(this.constructor.name+"-validate is not yet implemented")}},{key:"reset",value:function(){throw new Error(this.constructor.name+"-reset is not yet implemented")}}]),i}();exports.default=a;
},{"../utilities/zeros-2d":"C4Cz","./types":"pX1U"}],"JVtt":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),t=function e(t,r,n){null===t&&(t=Function.prototype);var i=Object.getOwnPropertyDescriptor(t,r);if(void 0===i){var s=Object.getPrototypeOf(t);return null===s?void 0:e(s,r,n)}if("value"in i)return i.value;var a=i.get;return void 0!==a?a.call(n):void 0},r=require("./layer/recurrent-connection"),n=d(r),i=require("./layer/recurrent-input"),s=d(i),a=require("./layer/recurrent-zeros"),u=d(a),o=require("./utilities/flatten-layers"),h=d(o),l=require("./utilities/mse-2d"),c=d(l),p=require("./feed-forward"),y=d(p);function d(e){return e&&e.__esModule?e:{default:e}}function _(e){if(Array.isArray(e)){for(var t=0,r=Array(e.length);t<e.length;t++)r[t]=e[t];return r}return Array.from(e)}function f(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function L(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function v(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var g=function(r){function i(){return f(this,i),L(this,(i.__proto__||Object.getPrototypeOf(i)).apply(this,arguments))}return v(i,y.default),e(i,[{key:"_connectLayers",value:function(){var e=[],t=this.inputLayer(),r=this._connectHiddenLayers(t);this._outputConnection.setLayer(r[r.length-1]);var n=this.outputLayer(this._outputConnection,r.length);e.push(t),e.push.apply(e,_(r)),e.push(n);var i=(0,h.default)(e);this._inputLayers=i.slice(0,i.indexOf(t)+1),this._hiddenLayers=[i.slice(i.indexOf(t)+1,i.indexOf(r[r.length-1])+1)],this._outputLayers=i.slice(i.indexOf(r[r.length-1])+1),this._outputLayers.unshift(),this._recurrentIndices=[],this._model=[];for(var s=0;s<this._hiddenLayers[0].length;s++)"Model"===Object.getPrototypeOf(this._hiddenLayers[0][s].constructor).name&&(this._model.push(this._hiddenLayers[0][s]),this._hiddenLayers[0].splice(s,1));for(var a=0;a<r.length;a++)this._recurrentIndices.push(this._hiddenLayers[0].indexOf(r[a]))}},{key:"_connectHiddenLayers",value:function(e){for(var t=[],r=0;r<this.hiddenLayers.length;r++){var n=new u.default,i=this.hiddenLayers[r](e,n,r);e=i,t.push(i)}return t}},{key:"_connectHiddenLayersDeep",value:function(){for(var e=[],t=this._hiddenLayers[this._hiddenLayers.length-1],r=this._hiddenLayers[0],n=0,i=0;i<t.length;i++){var a=t[i],u=null;switch(Object.getPrototypeOf(r[i].constructor).name){case"Activation":var o=e[t.indexOf(a.inputLayer)]||a.inputLayer;u=new a.constructor(o);break;case"Filter":var h=a,l=e[t.indexOf(a.inputLayer)]||a.inputLayer;u=new a.constructor(h,l);break;case"Internal":switch(a.constructor.name){case"RecurrentConnection":break;case"RecurrentInput":case"RecurrentZeros":default:(u=new s.default).setDimensions(a.width,a.height),u.setRecurrentInput(t[this._recurrentIndices[n]]),n++}break;case"Model":u=a;break;case"Modifier":var c=e[t.indexOf(a.inputLayer)]||a.inputLayer;u=new a.constructor(c);break;case"Operator":var p=e[t.indexOf(a.inputLayer1)]||a.inputLayer1,y=e[t.indexOf(a.inputLayer2)]||a.inputLayer2;u=new a.constructor(p,y);break;default:throw new Error("hidden layer "+a.constructor.name+" extends unknown hidden layer "+Object.getPrototypeOf(a.constructor).name)}e[i]=u}return this._hiddenLayers.push(e),e}},{key:"initialize",value:function(){this._previousInputs=[],this._outputConnection=new n.default,this._connectLayers(),this.initializeLayers(this._model),this.initializeLayers(this._inputLayers),this.initializeLayers(this._hiddenLayers[0]),this.initializeLayers(this._outputLayers)}},{key:"initializeDeep",value:function(){for(var e=this._connectHiddenLayersDeep(),t=0;t<e.length;t++){e[t].reuseKernels(this._hiddenLayers[0][t])}}},{key:"runInput",value:function(e){for(var t=e.length-1,r=0;r<t;r++){var n=this._hiddenLayers[r],i=n[n.length-1];this._outputConnection.setLayer(i),this._inputLayers[0].predict([e[r]]),this._previousInputs.push(this._inputLayers[0].weights);for(var s=1;s<this._inputLayers.length;s++)this._inputLayers[s].predict();for(var a=0;a<this._hiddenLayers[r].length;a++)this._hiddenLayers[r][a].predict();for(var u=0;u<this._outputLayers.length;u++)this._outputLayers[u].predict()}return this._outputLayers[this._outputLayers.length-1].weights}},{key:"_prepTraining",value:function(e,r){var n=t(i.prototype.__proto__||Object.getPrototypeOf(i.prototype),"_prepTraining",this).call(this,e,r);return this.initializeDeep(),n}},{key:"_calculateDeltas",value:function(e,t){for(var r=e.length-1;r>=0;r--){var n=t+r,i=this._hiddenLayers[n],s=i[i.length-1];this._outputConnection.setLayer(s),this._previousInputs.length>0&&(this._inputLayers[0].weights=this._previousInputs.pop()),this._outputLayers[this._outputLayers.length-1].compare([e[r]]);for(var a=this._outputLayers.length-2;a>=0;a--)this._outputLayers[a].compare();for(var u=i.length-1;u>=0;u--)i[u].compare();for(var o=this._inputLayers.length-1;o>=1;o--)this._inputLayers[o].compare()}}},{key:"_adjustWeights",value:function(){for(var e=0;e<this._hiddenLayers.length;e++){var t=this._hiddenLayers[e],r=t[t.length-1];this._outputConnection.setLayer(r);for(var n=0;n<this._inputLayers.length;n++)this._inputLayers[n].learn();for(var i=0;i<t.length;i++)t[i].learn();for(var s=0;s<this._outputLayers.length;s++)this._outputLayers[s].learn();for(var a=0;a<this._model.length;a++)this._model[a].learn()}}},{key:"_trainPattern",value:function(e,t,r){if(this.runInput(e),this._calculateDeltas(t,e.length-1),this._calculateDeltas(e.slice(1),0),this._adjustWeights(),r){var n=this._outputLayers[this._outputLayers.length-1];return(0,c.default)(n.errors.hasOwnProperty("toArray")?n.errors.toArray():n.errors)}return null}}],[{key:"structure",get:function(){return{_inputLayers:null,_hiddenLayers:null,_outputLayers:null,_outputConnection:null,_previousInputs:null,_model:null,_recurrentIndices:null}}}]),i}();exports.default=g;
...
//# sourceMappingURL=/brain-browser.min.map