...
exports.getCompareFilterDeltasIndexStart = getCompareFilterDeltasIndexStart;
exports.getCompareFilterDeltasIndexStop = getCompareFilterDeltasIndexStop;
exports.getCompareFilterInputIndexStart = getCompareFilterInputIndexStart;
exports.getCompareFilterInputIndexStop = getCompareFilterInputIndexStop;
...
function compareFilters(filterDeltas, inputs, deltas) {
  var inputX = getCompareFilterInputIndexStart(this.thread.x, this.constants.paddingX);
  var inputY = getCompareFilterInputIndexStart(this.thread.y, this.constants.paddingY);
  var maxInputX = getCompareFilterInputIndexStop(this.thread.x, this.constants.paddingX, this.constants.deltaWidth, this.constants.inputWidth);
  var maxInputY = getCompareFilterInputIndexStop(this.thread.y, this.constants.paddingY, this.constants.deltaHeight, this.constants.inputHeight);

  var deltaY = getCompareFilterDeltasIndexStart(this.thread.y, this.constants.strideY, this.constants.paddingY);

  var deltaX = getCompareFilterDeltasIndexStart(this.thread.x, this.constants.strideX, this.constants.paddingX);

  var maxDeltaY = getCompareFilterDeltasIndexStop(this.thread.y, this.constants.strideY, this.constants.paddingY, this.constants.deltaHeight, this.constants.outputHeight);

  var maxDeltaX = getCompareFilterDeltasIndexStop(this.thread.x, this.constants.strideX, this.constants.paddingX, this.constants.deltaWidth, this.constants.outputWidth);

  var sum = filterDeltas[this.thread.z][this.thread.y][this.thread.x];
  for (var y = 0; y < this.constants.deltasHeight; y += this.constants.strideY) {
    for (var x = 0; x < this.constants.deltasX; x += this.constants.strideX) {
